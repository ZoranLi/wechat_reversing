...
public class Grammar {
    ...
    private String a() {
        ...
        for (int i2 = 0; i2 < this.e.size(); i2++) {
            ((d) this.e.get(i2)).aIQ = a(((d) this.e.get(i2)).userName);
            ((d) this.e.get(i2)).aIR = a(((d) this.e.get(i2)).aIO);
            ((d) this.e.get(i2)).aIS = a(((d) this.e.get(i2)).aIP);
        }
    ...
    public int getResult(a aVar) {
        ...
        int i = 0;
        while (i < this.e.size()) {
            if (((d) this.e.get(i)).aIQ.compareTo(this.b.name) == 0) {
                aVar.name = ((d) this.e.get(i)).userName;
                return 0;
            } else if (((d) this.e.get(i)).aIR.compareTo(this.b.name) == 0) {
                aVar.name = ((d) this.e.get(i)).userName;
                return 0;
            } else if (((d) this.e.get(i)).aIS.compareTo(this.b.name) == 0) {
                aVar.name = ((d) this.e.get(i)).userName;
                return 0;
            } else {
                i++;
