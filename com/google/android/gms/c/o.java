...
public class o<K, V> {
    private final LinkedHashMap<K, V> aAb;
    private int aAc;
    private int aAd;
    private int aAe;
    private int aAf;
    ...
    public final synchronized String toString() {
        ...
        int i = 0;
        synchronized (this) {
            int i2 = this.aAf + this.aAg;
            if (i2 != 0) {
                i = (this.aAf * 100) / i2;
            }
            format = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.aAc), Integer.valueOf(this.aAf), Integer.valueOf(this.aAg), Integer.valueOf(i)});
        }
        return format;
    }
