...
public final class e {
    ...
    private e(Context context, String str) {
        ...
        this.atU = context.getSharedPreferences(str, 4);
    ...
    private synchronized String get(String str, String str2) {
        return this.atU.getString(str + "|S|" + str2, null);
    }

    final synchronized KeyPair a(String str, long j) {
        KeyPair kG;
        kG = b.kG();
        Editor edit = this.atU.edit();
        a(edit, str, "|P|", a.d(kG.getPublic().getEncoded()));
        a(edit, str, "|K|", a.d(kG.getPrivate().getEncoded()));
    ...
    public final synchronized void ab(String str) {
        Editor edit = this.atU.edit();
        for (String str2 : this.atU.getAll().keySet()) {
    ...
    public final synchronized String d(String str, String str2, String str3) {
        return this.atU.getString(c(str, str2, str3), null);
    }

    final synchronized String get(String str) {
        return this.atU.getString(str, null);
    }
