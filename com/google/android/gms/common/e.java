...
public final class e {
    ...
    L_0x000a:
        return r3;
    L_0x000b:
        r0 = com.google.android.gms.c.t.J(r11);
    ...
    L_0x00a2:
        r7 = 11;
        r7 = com.google.android.gms.c.z.cc(r7);
    ...
    L_0x01c7:
        r1 = 11;
        r1 = com.google.android.gms.c.z.cc(r1);
        ...
        synchronized (agS) {
            if (amg == -1) {
                try {
                    ...
                    k.kC();
                    if (k.a(packageInfo, j.asJ[1]) != null) {
                        amg = 1;
                    } else {
                        amg = 0;
                    }
    ...
    public static boolean b(PackageManager packageManager) {
        if (!a(packageManager)) {
            if (ame ? amf : "user".equals(Build.TYPE)) {
                return false;
            }
        }
        return true;
    ...
    public static boolean l(Context context, int i) {
        if (a(context, i, "com.google.android.gms")) {
            if (k.kC().a(context.getPackageManager(), "com.google.android.gms")) {
                return true;
            }
        }
        return false;
    ...
    public static int w(Context context) {
        ...
        if (!"com.google.android.gms".equals(context.getPackageName())) {
            ...
            synchronized (agS) {
                ...
                } else if (!amh.equals(context.getPackageName())) {
                    throw new IllegalArgumentException("isGooglePlayServicesAvailable should only be called with Context from your application's package. A previous call used package '" + amh + "' and this call used package '" + context.getPackageName() + "'.");
                }
                num = ami;
            }
            if (num == null) {
                throw new IllegalStateException("A required meta-data tag in your app's AndroidManifest.xml does not exist.  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version\" android:value=\"@integer/google_play_services_version\" />");
            } else if (num.intValue() != amc) {
                throw new IllegalStateException("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected " + amc + " but found " + num + ".  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version" + "\" android:value=\"@integer/google_play_services_version\" />");
            }
        }
        try {
            PackageInfo packageInfo = packageManager.getPackageInfo("com.google.android.gms", 64);
            k.kC();
            if (!t.cb(packageInfo.versionCode) && !t.J(context)) {
                try {
                    if (k.a(packageManager.getPackageInfo("com.android.vending", 64), aw.asN) == null) {
                        return 9;
                    }
                    if (k.a(packageInfo, k.a(packageManager.getPackageInfo("com.android.vending", 64), aw.asN)) == null) {
                        return 9;
                    }
                    ...
                    if (k.a(packageInfo, aw.asN) == null) {
                        return 9;
                    }
                }
            } else if (k.a(packageInfo, aw.asN) == null) {
                return 9;
            }
            if (t.ca(packageInfo.versionCode) < t.ca(amc)) {
    ...
    public static void y(Context context) {
        ...
        if (w != 0) {
            ...
            throw new d(w, "Google Play Services not available", bO);
        }
    }
