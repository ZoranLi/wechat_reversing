...
public final class e implements Creator<SafeParcelResponse> {
    static void a(SafeParcelResponse safeParcelResponse, Parcel parcel, int i) {
        ...
        Parcel kv = safeParcelResponse.kv();
        if (kv != null) {
            int t2 = b.t(parcel, 2);
            parcel.appendFrom(kv, 0, kv.dataSize());
            b.u(parcel, t2);
        }
        switch (safeParcelResponse.arK) {
            case 0:
                parcelable = null;
                break;
            case 1:
                parcelable = safeParcelResponse.arB;
                break;
            case 2:
                parcelable = safeParcelResponse.arB;
                break;
            default:
                throw new IllegalStateException("Invalid creation type: " + safeParcelResponse.arK);
        }
