...
public final class c implements Creator<FieldMappingDictionary> {
    static void a(FieldMappingDictionary fieldMappingDictionary, Parcel parcel) {
        ...
        for (String str : fieldMappingDictionary.arD.keySet()) {
            arrayList.add(new Entry(str, (Map) fieldMappingDictionary.arD.get(str)));
        }
        b.b(parcel, 2, arrayList);
        b.a(parcel, 3, fieldMappingDictionary.arF);
        b.u(parcel, t);
    }
