...
public final class g implements Creator<WakeLockEvent> {
    static void a(WakeLockEvent wakeLockEvent, Parcel parcel) {
        ...
        b.a(parcel, 2, wakeLockEvent.arN);
        b.a(parcel, 4, wakeLockEvent.arY);
        b.c(parcel, 5, wakeLockEvent.arZ);
        b.a(parcel, 6, wakeLockEvent.asa);
        b.a(parcel, 8, wakeLockEvent.arV);
        b.a(parcel, 10, wakeLockEvent.asd);
        b.c(parcel, 11, wakeLockEvent.arO);
        b.a(parcel, 12, wakeLockEvent.asb);
        b.a(parcel, 13, wakeLockEvent.ase);
        b.c(parcel, 14, wakeLockEvent.asc);
        float f = wakeLockEvent.asf;
        b.b(parcel, 15, 4);
        parcel.writeFloat(f);
        b.u(parcel, t);
    }
