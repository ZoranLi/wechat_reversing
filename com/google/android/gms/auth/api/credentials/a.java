...
public final class a implements Creator<Credential> {
    static void a(Credential credential, Parcel parcel, int i) {
        ...
        b.a(parcel, MMBitmapFactory.ERROR_ALLOCATE_STRUCT_FAILED, credential.ala);
        b.a(parcel, 1, credential.ahk);
        b.c(parcel, 1000, credential.mVersionCode);
        b.a(parcel, 2, credential.mName);
        b.a(parcel, 3, credential.alc, i);
        b.a(parcel, MMBitmapFactory.ERROR_LOCK_BITMAP_FAILED, credential.alb);
        b.b(parcel, 4, credential.ald);
        b.a(parcel, 5, credential.ale);
        b.a(parcel, 6, credential.alf);
        b.a(parcel, 7, credential.alg);
        b.a(parcel, 8, credential.alh);
        b.u(parcel, t);
    }
