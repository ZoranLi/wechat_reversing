...
public final class e implements Creator<PasswordSpecification> {
    static void a(PasswordSpecification passwordSpecification, Parcel parcel) {
        ...
        b.a(parcel, 1, passwordSpecification.alr);
        b.c(parcel, 1000, passwordSpecification.mVersionCode);
        b.a(parcel, 2, passwordSpecification.als);
        List list = passwordSpecification.alt;
        if (list != null) {
            int t2 = b.t(parcel, 3);
            int size = list.size();
        ...
        b.c(parcel, 4, passwordSpecification.alu);
        b.c(parcel, 5, passwordSpecification.alv);
        b.u(parcel, t);
    }
