...
final class u extends o implements Closeable {
    public static final String aiW = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL, '%s' TEXT NOT NULL, '%s' INTEGER);", new Object[]{"hits2", "hit_id", "hit_time", "hit_url", "hit_string", "hit_app_id"});
    private static final String aiX = String.format("SELECT MAX(%s) FROM %s WHERE 1;", new Object[]{"hit_time", "hits2"});
    private final a aiY;
    private final j aiZ = new j(this.ahK.ahZ);
    public final j aja = new j(this.ahK.ahZ);

    class a extends SQLiteOpenHelper {
        final /* synthetic */ u ajb;
        ...
        private boolean a(SQLiteDatabase sQLiteDatabase, String str) {
            ...
            try {
                ...
                try {
                    ...
                    e = e2;
                    try {
                        this.ajb.c("Error querying for table", str, e);
                        if (query != null) {
                            query.close();
                        }
                        return false;
        ...
        public final SQLiteDatabase getWritableDatabase() {
            if (this.ajb.aja.f(3600000)) {
                SQLiteDatabase writableDatabase;
                try {
                    writableDatabase = super.getWritableDatabase();
                } catch (SQLiteException e) {
                    this.ajb.aja.start();
                    this.ajb.G("Opening the database failed, dropping the table and recreating it");
                    this.ajb.ahK.mContext.getDatabasePath(this.ajb.iu()).delete();
                    try {
                        writableDatabase = super.getWritableDatabase();
                        this.ajb.aja.aia = 0;
                    } catch (SQLiteException e2) {
                        this.ajb.g("Failed to open freshly created database", e2);
                        throw e2;
                    }
                }
    ...
    u(q qVar) {
        super(qVar);
        this.aiY = new a(this, qVar.mContext, iu());
    }
    ...
    public final void b(s sVar) {
        ...
        contentValues.put("app_uid", Long.valueOf(sVar.aiH));
        contentValues.put("cid", sVar.aiI);
        contentValues.put("tid", sVar.aiJ);
        contentValues.put("adid", Integer.valueOf(sVar.aiK ? 1 : 0));
        contentValues.put("hits_count", Long.valueOf(sVar.aiL));
    ...
    public final void e(c cVar) {
        ...
        if (str.length() > 8192) {
            this.ahK.ig().a(cVar, "Hit length exceeds the maximum allowed size");
            return;
        }
        int intValue = ((Integer) aj.ajT.get()).intValue();
        long iq = iq();
        if (iq > ((long) (intValue - 1))) {
            List g = g((iq - ((long) intValue)) + 1);
        ...
        contentValues.put("hit_time", Long.valueOf(cVar.ahA));
        contentValues.put("hit_app_id", Integer.valueOf(cVar.ahB));
        contentValues.put("hit_url", cVar.ahC ? ac.iQ() : ac.iR());
        try {
    ...
    L_0x0009:
        com.google.android.gms.common.internal.w.ad(r0);
    ...
    public final int ir() {
        q.im();
        ie();
        if (!this.aiZ.f(86400000)) {
            return 0;
        }
        this.aiZ.start();
        C("Deleting stale hits (if any)");
        int delete = getWritableDatabase().delete("hits2", "hit_time < ?", new String[]{Long.toString(this.ahK.ahZ.currentTimeMillis() - 2592000000L)});
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.List<com.google.android.gms.analytics.internal.s> it() {
        /*
        r14 = this;
        r9 = 0;
        r10 = 1;
        ...
        r3 = "params";
        r2[r1] = r3;	 Catch:{ SQLiteException -> 0x00ca, all -> 0x00c8 }
        r1 = com.google.android.gms.analytics.internal.aj.ajV;	 Catch:{ SQLiteException -> 0x00ca, all -> 0x00c8 }
    ...
    L_0x00ca:
        ...
        goto L_0x00b9;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.analytics.internal.u.it():java.util.List<com.google.android.gms.analytics.internal.s>");
    }

    public final String iu() {
        return !f.apP ? "google_analytics_v4.db" : this.ahK.ais.iJ() ? "google_analytics_v4.db" : "google_analytics2_v4.db";
    }
