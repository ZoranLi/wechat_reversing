...
public abstract class SearchActionVerificationClientService extends IntentService {
    private final boolean aIa = mI();
    private final long aIb = 1000;
    private final Intent aIc = new Intent("com.google.android.googlequicksearchbox.SEARCH_ACTION_VERIFICATION_SERVICE").setPackage("com.google.android.googlequicksearchbox");
    private a aId;
    private com.google.android.search.verification.a.a aIe = null;

    class a implements ServiceConnection {
        final /* synthetic */ SearchActionVerificationClientService aIf;

        a(SearchActionVerificationClientService searchActionVerificationClientService) {
            this.aIf = searchActionVerificationClientService;
        }

        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            this.aIf.aIe = com.google.android.search.verification.a.a.a.v(iBinder);
        }
    ...
    protected final void onHandleIntent(Intent intent) {
        ...
        if (intent != null) {
            ...
            while (!isConnected() && System.nanoTime() - nanoTime < this.aIb * 1000000) {
                try {
                    Thread.sleep(50);
            ...
            if (!isConnected()) {
                ...
                try {
                    new StringBuilder(24).append("API version: ").append(this.aIe.getVersion());
                    Bundle bundle = new Bundle();
                    if (!(z2 && this.aIe.a(intent2, bundle))) {
                        z = false;
                    }
                    a(intent2, z);
    ...
    public final void onCreate() {
        super.onCreate();
        this.aId = new a(this);
        bindService(this.aIc, this.aId, 1);
    }

    public final void onDestroy() {
        super.onDestroy();
        unbindService(this.aId);
    }
