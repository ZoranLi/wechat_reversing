...
public final class c extends b {
    static boolean a(Context context, String str, String str2, File file) {
        ...
        ShareBsDiffPatchInfo.j(str2, arrayList);
        if (arrayList.isEmpty()) {
            a.w("Tinker.BsDiffPatchInternal", "extract patch list is empty! type:%s:", new Object[]{ShareTinkerInternals.DZ(5)});
            return true;
        }
            ...
            try {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        String str4 = shareBsDiffPatchInfo.fFW;
                        if (SharePatchFileUtil.VU(str4)) {
                            File file3 = new File(str + (shareBsDiffPatchInfo.path + "/" + shareBsDiffPatchInfo.name));
                            if (!file3.exists()) {
                                file3.getParentFile().mkdirs();
                            } else if (str4.equals(SharePatchFileUtil.X(file3))) {
                            ...
                            if (entry == null) {
                            ...
                            } else if (SharePatchFileUtil.VU(str5)) {
                                ...
                                if (String.valueOf(entry2.getCrc()).equals(str5)) {
                                    ...
                                    if (SharePatchFileUtil.e(file3, str4)) {
                                ...
                                a.w("Tinker.BsDiffPatchInternal", "meta file md5 mismatch, type:%s, name: %s, md5: %s", new Object[]{ShareTinkerInternals.DZ(5), shareBsDiffPatchInfo.name, str5});
                                hp.xgr.d(file, b.DV(5));
                                SharePatchFileUtil.a(zipFile3);
                                SharePatchFileUtil.a(zipFile4);
                                return false;
                            }
                        }
                        a.w("Tinker.BsDiffPatchInternal", "meta file md5 mismatch, type:%s, name: %s, md5: %s", new Object[]{ShareTinkerInternals.DZ(5), shareBsDiffPatchInfo.name, shareBsDiffPatchInfo.fFW});
                        hp.xgr.d(file, b.DV(5));
                        SharePatchFileUtil.a(zipFile3);
                        SharePatchFileUtil.a(zipFile4);
                        return false;
