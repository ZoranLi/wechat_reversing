...
public class ShareFileLockHelper implements Closeable {
    private final FileOutputStream xiu;
    private final FileLock xiv;
...
*/
    ...
    private ShareFileLockHelper(File file) {
        this.xiu = new FileOutputStream(file);
        Throwable th = null;
        ...
        while (i < 3) {
            int i2 = i + 1;
            try {
                fileLock = this.xiu.getChannel().lock();
    ...
    public static ShareFileLockHelper T(File file) {
