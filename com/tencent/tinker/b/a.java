...
public final class a {
    public static int a(InputStream inputStream, InputStream inputStream2, File file) {
        ...
        byte[] p = b.p(inputStream);
        byte[] p2 = b.p(inputStream2);
        int length = p.length;
        int length2 = p2.length;
        DataInputStream dataInputStream = new DataInputStream(new ByteArrayInputStream(p2, 0, length2));
        dataInputStream.skip(8);
        long readLong = dataInputStream.readLong();
        long readLong2 = dataInputStream.readLong();
        int readLong3 = (int) dataInputStream.readLong();
        dataInputStream.close();
        InputStream byteArrayInputStream = new ByteArrayInputStream(p2, 0, length2);
        ...
        byteArrayInputStream = new ByteArrayInputStream(p2, 0, length2);
