        ...
        if (this.handler != null) {
            this.handler.post(new Runnable() {
                public void run() {
                    ...
                    tMQQDownloaderStateChangeParam.errorCode = bg.getInt(intent.getStringExtra(OpenSDKTool4Assistant.EXTRA_ERROR_CODE), 0);
                    tMQQDownloaderStateChangeParam.errorMsg = intent.getStringExtra(OpenSDKTool4Assistant.EXTRA_ERROR_MSG);
                    tMQQDownloaderStateChangeParam.state = bg.getInt(intent.getStringExtra("state"), 0);
                    ...
                    tMQQDownloaderOpenSDKParam.taskVersion = bg.getInt(intent.getStringExtra(OpenSDKTool4Assistant.EXTRA_TASK_VERSION), 0);
