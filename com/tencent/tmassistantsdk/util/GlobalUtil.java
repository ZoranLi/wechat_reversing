...
public class GlobalUtil {
    ...
    public static int getAppVersionCode(Context context) {
        ...
        try {
            ...
            w.printErrStackTrace(TAG, e, "", new Object[i]);
            return i;
        }
    }
    ...
    public String getImei() {
        ...
        try {
            ...
            w.printErrStackTrace(TAG, e, "getImei:", new Object[0]);
            return str;
        }
    }
    ...
    public String getImsi() {
        ...
        try {
            ...
            w.printErrStackTrace(TAG, e, "getImsi:", new Object[0]);
            return str;
        }
    }
    ...
    public int getQQDownloaderAPILevel() {
        ...
        if (this.mContext != null) {
            try {
                ApplicationInfo applicationInfo = this.mContext.getPackageManager().getApplicationInfo("com.tencent.android.qqdownloader", FileUtils.S_IWUSR);
