...
public class LogReportManager {
    public static final Class<?>[] REPORT_MANAGERS = new Class[]{DownloadReportManager.class, TipsInfoReportManager.class, UpdateInfoReportManager.class};
        ...
        public void onNetworkChanged() {
            ...
            for (Object obj : LogReportManager.REPORT_MANAGERS) {
                try {
                    ...
                    w.printErrStackTrace(LogReportManager.TAG, e, "", new Object[0]);
                }
            }
