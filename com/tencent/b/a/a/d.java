...
final class d extends q {
    ...
    protected final String nL() {
        ...
        synchronized (this) {
            try {
                for (String str2 : c.c(new File(Environment.getExternalStorageDirectory(), s.decode("6X8Y4XdM2Vhvn0KfzcEatGnWaNU=")))) {
    ...
    protected final void write(String str) {
        synchronized (this) {
            c.aG(Environment.getExternalStorageDirectory() + "/" + s.decode("6X8Y4XdM2Vhvn0I="));
            try {
