...
public class NotifyFreqLimit extends BroadcastReceiver {
    ...
    private static a hLh = null;
    private static n hLi = null;
    private static int hLj = 0;
    private static long[] hLk = null;
    private static LinkedList<Object> hLl = new LinkedList();
    private static int hLm = 0;
    private static Boolean hLn = null;
    private static Boolean hLo = null;
    private static long hLp = 0;
    private static PendingIntent hLq = null;
    ...
    public void onReceive(android.content.Context r23, android.content.Intent r24) {
        /*
        r22 = this;
        r11 = hAl;	 Catch:{ Throwable -> 0x00fb }
    ...
    L_0x0021:
        ...
        com.tencent.mm.sdk.platformtools.w.e(r3, r4, r5);	 Catch:{ all -> 0x00f8 }
    ...
    L_0x002d:
        ...
        r2 = com.tencent.mm.sdk.platformtools.bg.Nz();	 Catch:{ all -> 0x00f8 }
        r14 = r2 - r12;
        r2 = "pid";
        r3 = 0;
        r0 = r24;
        ...
        r5[r6] = r7;	 Catch:{ all -> 0x00f8 }
        r6 = 6;
        r7 = hLq;	 Catch:{ all -> 0x00f8 }
        r5[r6] = r7;	 Catch:{ all -> 0x00f8 }
        r6 = 7;
        r7 = hLh;	 Catch:{ all -> 0x00f8 }
        r5[r6] = r7;	 Catch:{ all -> 0x00f8 }
        com.tencent.mm.sdk.platformtools.w.i(r3, r4, r5);	 Catch:{ all -> 0x00f8 }
        r3 = hLq;	 Catch:{ all -> 0x00f8 }
        if (r3 != 0) goto L_0x0120;
    L_0x00a8:
        r3 = com.tencent.mm.plugin.report.service.g.oUh;	 Catch:{ all -> 0x00f8 }
        r4 = 99;
        ...
        r5[r2] = r6;	 Catch:{ all -> 0x00f8 }
        r2 = 6;
        r6 = hLq;	 Catch:{ all -> 0x00f8 }
        r5[r2] = r6;	 Catch:{ all -> 0x00f8 }
        r2 = 7;
        r6 = hLh;	 Catch:{ all -> 0x00f8 }
        r5[r2] = r6;	 Catch:{ all -> 0x00f8 }
        com.tencent.mm.sdk.platformtools.w.e(r3, r4, r5);	 Catch:{ all -> 0x00f8 }
        monitor-exit(r11);	 Catch:{ all -> 0x00f8 }
        goto L_0x0027;
    ...
    L_0x0188:
        ...
        hLo = r3;	 Catch:{ all -> 0x00f8 }
        r3 = com.tencent.mm.sdk.platformtools.ab.getContext();	 Catch:{ all -> 0x00f8 }
        ...
        r4 = com.tencent.mm.sdk.platformtools.bg.mz(r4);	 Catch:{ all -> 0x00f8 }
        ...
        r8 = com.tencent.mm.sdk.platformtools.bg.Nz();	 Catch:{ all -> 0x00f8 }
        ...
        r3 = com.tencent.mm.sdk.platformtools.bg.mA(r4);	 Catch:{ all -> 0x00f8 }
    ...
    L_0x022c:
        ...
        r6 = new java.lang.Object[r6];	 Catch:{ all -> 0x00f8 }
        r7 = 0;
        r8 = hLo;	 Catch:{ all -> 0x00f8 }
        r6[r7] = r8;	 Catch:{ all -> 0x00f8 }
        r7 = 1;
        r6[r7] = r4;	 Catch:{ all -> 0x00f8 }
        com.tencent.mm.sdk.platformtools.w.i(r3, r5, r6);	 Catch:{ all -> 0x00f8 }
    L_0x0240:
        r3 = hLh;	 Catch:{ all -> 0x00f8 }
