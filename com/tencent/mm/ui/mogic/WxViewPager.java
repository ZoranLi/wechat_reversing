...
public class WxViewPager extends ViewGroup {
    private static final e wjF = new e();
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, WxViewPager.ym);
    ...
    class c extends android.support.v4.view.a {
        ...
        public final void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            ch.setScrollable(bY());
            if (accessibilityEvent.getEventType() == Downloads.RECV_BUFFER_SIZE && this.wjG.yr != null) {
                ch.setItemCount(this.wjG.yr.getCount());
                ch.setFromIndex(this.wjG.ys);
                ch.setToIndex(this.wjG.ys);
            }
        }
        ...
        public final void a(View view, android.support.v4.view.a.b bVar) {
            ...
            if (this.wjG.canScrollHorizontally(1)) {
        ...
        private boolean bY() {
            return this.wjG.yr != null && this.wjG.yr.getCount() > 1;
        }
    }
    ...
    public void a(u uVar) {
        if (this.yr != null) {
            int i;
            this.yr.unregisterDataSetObserver(this.wjE);
        ...
        if (this.yr != null) {
            ...
            this.yr.registerDataSetObserver(this.wjE);
            this.yI = false;
            boolean z = this.yW;
            this.yW = true;
    ...
    private void a(int i, boolean z, int i2, boolean z2) {
        ...
        int i3 = 0;
        if (Cc != null) {
            i3 = (int) (((float) bP()) * Math.max(this.yD, Math.min(Cc.zn, this.yE)));
        }
        if (z) {
            if (getChildCount() == 0) {
                setScrollingCacheEnabled(false);
    ...
    public final void u(int i, int i2, int i3, int i4) {
        if (i2 <= 0 || this.eh.isEmpty()) {
            b Cc = Cc(this.ys);
            int min = (int) ((Cc != null ? Math.min(Cc.zn, this.yE) : 0.0f) * ((float) ((i - getPaddingLeft()) - getPaddingRight())));
            if (min != getScrollX()) {
                r(false);
        ...
        if (!this.yw.isFinished()) {
            this.yw.startScroll(paddingLeft, 0, (int) (Cc(this.ys).zn * ((float) i)), 0, this.yw.getDuration() - this.yw.timePassed());
        }
    }
        ...
        for (paddingRight = 0; paddingRight < childCount; paddingRight++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams.zo) {
                    b dA = dA(childAt2);
                    if (dA != null) {
                        i5 = ((int) (dA.zn * ((float) max))) + paddingLeft;
                        if (layoutParams.zp) {
    ...
    private boolean ab(int i) {
        ...
        int i3 = bZp.position;
        float f2 = ((((float) i) / ((float) bP)) - bZp.zn) / (bZp.zm + f);
        bP = (int) (((float) i2) * f2);
        this.yY = false;
        a(i3, f2, bP);
        if (this.yY) {
        ...
        switch (motionEvent.getAction() & 255) {
            ...
            case 1:
                if (this.iC) {
                    ...
                    b bZp = bZp();
                    int i = bZp.position;
                    f = ((((float) scrollX) / ((float) bP)) - bZp.zn) / bZp.zm;
                    bP = o.b(motionEvent, this.fl);
                    if (bP < 0) {
                        bP = 0;
                    }
                    if (Math.abs((int) (o.d(motionEvent, bP) - this.xC)) <= this.yR || Math.abs(a) <= this.yP) {
                        bP = (int) ((i >= this.ys ? 0.6f : 0.4f) + (((float) i) + f));
                    } else {
                        bP = a > 0 ? i : i + 1;
                    }
                    if (this.eh.size() > 0) {
                        bP = Math.max(bSD(), Math.min(bP, bSE()));
                    }
                    a(bP, true, true, a);
                    this.fl = -1;
                    cz();
            ...
            case 2:
                if (!this.iC) {
                    ...
                    float abs = Math.abs(d - this.yN);
                    f = o.e(motionEvent, bP);
                    x = Math.abs(f - this.yO);
                    if (abs > ((float) this.iE) && abs > x) {
                        this.iC = true;
                        if (d - this.xC > 0.0f) {
    ...
    public int bSD() {
        return ((b) this.eh.get(0)).position;
    }

    public int bSE() {
        return ((b) this.eh.get(this.eh.size() - 1)).position;
    }
        ...
        if (descendantFocusability != 393216) {
            for (int i3 = 0; i3 < getChildCount(); i3++) {
                ...
                if (childAt.getVisibility() == 0) {
                    b dA = dA(childAt);
                    if (dA != null && dA.position == this.ys) {
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        while (childCount != i2) {
            ...
            if (childAt.getVisibility() == 0) {
                b dA = dA(childAt);
                if (dA != null && dA.position == this.ys && childAt.requestFocus(i, rect)) {
                    return true;
                }
            }
            childCount += i3;
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt.getVisibility() == 0) {
                b dA = dA(childAt);
                if (dA != null && dA.position == this.ys && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                    return true;
                }
            }
        }
