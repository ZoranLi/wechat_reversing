...
public class AddressView extends View implements a, d.a {
    ...
    public AddressView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.drawable = getResources().getDrawable(R.g.bjX);
        this.needUpdatePostion = true;
        this.AVATAR_LAYOUT_WIDTH = getResources().getDimensionPixelSize(R.f.aWL);
        this.AVATAR_WIDTH = getResources().getDimensionPixelSize(R.f.aWL);
        this.NAME_TEXT_SIZE = (float) com.tencent.mm.bg.a.T(context, R.f.aXI);
        this.DESCRIPTION_TEXT_SIZE = (float) com.tencent.mm.bg.a.T(context, R.f.aXW);
        this.WEIBO_ICON_SIZE = getResources().getDimensionPixelSize(R.f.aXP);
        this.AVATAR_START_POS = 0;
        this.AVATAR_PADDING = getResources().getDimensionPixelSize(R.f.aWD);
        this.COMMON_PADDING = 0;
        this.DESCRIPTION_PADDING = getResources().getDimensionPixelSize(R.f.aXv) * 2;
        this.TEXT_TOP_PADDING = getResources().getDimensionPixelSize(R.f.aXV);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.nameIsSpanned) {
            ...
            canvas.restore();
        } else if (bg.mA(this.description)) {
    ...
    public float getDesiredWidth(CharSequence charSequence, TextPaint textPaint) {
        ...
        if (charSequence == null) {
            w.w(TAG, "source is null, set it empty.");
            charSequence = "";
        }
    ...
    public void resumeAvatarLoad() {
        if (this.avatarDrawable != null) {
            ((com.tencent.mm.pluginsdk.ui.a) this.avatarDrawable).bEi();
        }
    }

    public void stopAvatarLoad() {
        if (this.avatarDrawable != null) {
            ((com.tencent.mm.pluginsdk.ui.a) this.avatarDrawable).bEh();
        }
    }
    ...
    public void updateTextColors() {
        ...
        w.e(TAG, "nickNameTextColor should not be null");
    }
    ...
    private TextPaint generateOnePaint() {
        ...
        textPaint.setColor(getResources().getColor(R.e.aVo));
        return textPaint;
    }
    ...
    private TextPaint generateDescriptionPaint() {
        ...
        textPaint.setColor(getResources().getColor(R.e.aUo));
        return textPaint;
    }
    ...
    private void installAccessibilityDelegate() {
        z.a((View) this, new android.support.v4.view.a(this) {
            final /* synthetic */ AddressView uOh;
            ...
            public final void onPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
                ...
                Object contentDescription = this.uOh.getContentDescription();
                if (bg.mA((String) contentDescription)) {
                    contentDescription = this.uOh.nickName;
                }
                accessibilityEvent.getText().add(contentDescription);
            }
            ...
            public final void a(View view, b bVar) {
                super.a(view, bVar);
                CharSequence contentDescription = this.uOh.getContentDescription();
                if (bg.mA((String) contentDescription)) {
                    contentDescription = this.uOh.nickName;
                }
