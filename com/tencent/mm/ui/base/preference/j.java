...
public final class j {
    private static HashMap<String, Constructor<?>> vrP = new HashMap();
    private static final Class<?>[] vrQ = new Class[]{Context.class, AttributeSet.class};
    final Object[] HD = new Object[2];
    ...
    L_0x0023:
        ...
        r2 = vrQ;	 Catch:{ NoSuchMethodException -> 0x0040, ClassNotFoundException -> 0x0079, Exception -> 0x007b }
        r1 = r1.getConstructor(r2);	 Catch:{ NoSuchMethodException -> 0x0040, ClassNotFoundException -> 0x0079, Exception -> 0x007b }
        r0 = vrP;	 Catch:{ NoSuchMethodException -> 0x0040, ClassNotFoundException -> 0x0079, Exception -> 0x00aa }
        r0.put(r7, r1);	 Catch:{ NoSuchMethodException -> 0x0040, ClassNotFoundException -> 0x0079, Exception -> 0x00aa }
    L_0x0032:
        r0 = r6.HD;	 Catch:{ NoSuchMethodException -> 0x0040, ClassNotFoundException -> 0x0079, Exception -> 0x00aa }
        r2 = 1;
