...
public class o extends PopupWindow {
    ...
    private OnTouchListener vlg;

    private class a extends FrameLayout {
        final /* synthetic */ o vlh;
        ...
        public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
            if (this.vlh.vlg == null || !this.vlh.vlg.onTouch(this, motionEvent)) {
    ...
    public void dismiss() {
        try {
            ...
            w.e("MicroMsg.MMPopupWindow", "dismiss exception, e = " + e.getMessage());
        }
    }
