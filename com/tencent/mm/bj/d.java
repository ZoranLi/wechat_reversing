...
public final class d extends AbstractCursor {
    ...
    public final int getInt(int i) {
        ...
        return bg.getInt(obj.toString(), 0);
    }
    ...
    public final long getLong(int i) {
        ...
        return bg.getLong(obj.toString(), 0);
    }
    ...
    public final float getFloat(int i) {
        ...
        return bg.getFloat(obj.toString(), 0.0f);
    }
    ...
    public final double getDouble(int i) {
        ...
        return bg.getDouble(obj.toString(), 0.0d);
    }
    ...
    private static int bD(Object obj) {
        if (obj == null) {
            return 0;
        }
