...
public class PluginResourceLoader extends Resources {
    public Resources gRX;
    private Method gRY;
    private Method gRZ;
    private HashMap<String, ZipFile> gSa;
    private final b<WeakReference<ConstantState>> gSb;

    private XmlResourceParser b(String str, int i, int i2, String str2) {
        try {
            return (XmlResourceParser) this.gRZ.invoke(this.gRX, new Object[]{str, Integer.valueOf(i), Integer.valueOf(i2), str2});
        } catch (Throwable e) {
            w.printErrStackTrace("MicroMsg.PluginResourceLoader", e, "", new Object[0]);
            return null;
        }
    }
    ...
    public InputStream openRawResource(int i, TypedValue typedValue) {
        ...
        for (Entry value : this.gSa.entrySet()) {
    ...
    private Drawable a(TypedValue typedValue, int i) {
        try {
            return (Drawable) this.gRY.invoke(this.gRX, new Object[]{typedValue, Integer.valueOf(i)});
        } catch (Exception e) {
    ...
    L_0x001d:
        r3 = r0.vW;
        r3 = r3[r2];
        r6 = com.tencent.mm.compatible.loader.b.vT;
    ...
    L_0x0038:
        ...
        r2 = "get form cache";
        com.tencent.mm.sdk.platformtools.w.v(r1, r2);
        r1 = r0;
        goto L_0x0006;
    L_0x0043:
        r0 = r0.vW;
    ...
    L_0x0066:
        ...
        com.tencent.mm.sdk.platformtools.w.v(r3, r6, r7);	 Catch:{ Exception -> 0x00c3 }
    ...
    private static InputStream b(ZipFile zipFile, TypedValue typedValue) {
        ...
        if (typedValue.string != null) {
            try {
                w.d("MicroMsg.PluginResourceLoader", "try load stream from zip, entry=%s, file=%s", new Object[]{typedValue.string.toString(), zipFile.getName()});
