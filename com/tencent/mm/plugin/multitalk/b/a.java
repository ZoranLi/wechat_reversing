...
public final class a extends i<b> {
    public static final String[] gUx = new String[]{i.a(b.gTP, "MultiTalkInfo"), "CREATE INDEX IF NOT EXISTS idx_MultiTalkInfo_key  on MultiTalkInfo  (  wxGroupId )"};
    ...
    public final com.tencent.mm.al.b Bl(java.lang.String r9) {
...
*/
    ...
    L_0x0034:
        r0 = new com.tencent.mm.al.b;	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
        ...
        r6 = java.lang.Integer.valueOf(r6);	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
        r4[r5] = r6;	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
        com.tencent.mm.sdk.platformtools.w.i(r2, r3, r4);	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
    ...
    L_0x00d9:
        ...
        r0 = r0.toString();	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
        com.tencent.mm.sdk.platformtools.w.e(r2, r0);	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
    ...
    L_0x0101:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.multitalk.b.a.Bl(java.lang.String):com.tencent.mm.al.b");
    }

    public a(e eVar) {
        super(eVar, b.gTP, "MultiTalkInfo", null);
    }

    public final LinkedList<b> aNr() {
    ...
    public final boolean a(b bVar) {
        ...
        w.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "save. wxGroupId=%s, groupId=%s, roomId =%d, roomKey =%d, routeId =%d, inviteUser=%s,memberCount=%d,createTime=%d", new Object[]{str, bVar.field_groupId, Integer.valueOf(bVar.field_roomId), Long.valueOf(bVar.field_roomKey), Integer.valueOf(bVar.field_routeId), bVar.field_inviteUserName, Integer.valueOf(bVar.field_memberCount), Long.valueOf(bVar.field_createTime)});
        try {
            boolean b = b(bVar);
            w.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "insert ret " + b + " for id=%s" + str);
            return b;
        } catch (Exception e) {
            w.e("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "save mulitalTalk failure!" + e.toString());
            return false;
        }
    }
    ...
    public final boolean b(b bVar) {
        ...
        w.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "update. wxGroupId=%s, groupId=%s, roomId =%d, roomKey =%d, routeId =%d, inviteUser=%s,memberCount=%d,createTime=%d,state=%d", new Object[]{str, bVar.field_groupId, Integer.valueOf(bVar.field_roomId), Long.valueOf(bVar.field_roomKey), Integer.valueOf(bVar.field_routeId), bVar.field_inviteUserName, Integer.valueOf(bVar.field_memberCount), Long.valueOf(bVar.field_createTime), Integer.valueOf(bVar.field_state)});
        try {
            boolean c = c(bVar, new String[]{"wxGroupId"});
            w.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "update ret " + c + " for id=%s" + str);
            return c;
        } catch (Exception e) {
            w.e("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "save mulitalTalk failure!" + e.toString());
            return false;
    ...
    public final boolean gR(String str) {
        w.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "delete id = %s", new Object[]{str});
        try {
            super.eE("MultiTalkInfo", "delete from MultiTalkInfo where wxGroupId = \"" + str + "\"");
            return true;
        } catch (Exception e) {
            w.e("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "delete fail for wxGroupId = " + str);
            return false;
        }
    }
}
