...
public class FFmpegMetadataRetriever {
    ...
    public class a {
        final /* synthetic */ FFmpegMetadataRetriever nGA;
        HashMap<String, String> nGz;

        public a(FFmpegMetadataRetriever fFmpegMetadataRetriever) {
            this.nGA = fFmpegMetadataRetriever;
        }
    }
    ...
    public int getVideoWidth() {
        try {
            ...
            w.e(TAG, "can not get video width %s", new Object[]{e.getMessage()});
            return 0;
        }
    }
    ...
    public int getVideoRotation() {
        ...
        try {
            ...
            w.e(TAG, "can not get video rotation. %s", new Object[]{e.getMessage()});
        }
        return i;
    }
    ...
    public int getVideoHeight() {
        try {
            ...
            w.d(TAG, "video height %s rotate %s", new Object[]{extractMetadata, extractMetadata2});
            return Integer.valueOf(extractMetadata).intValue();
        } catch (Exception e) {
            w.e(TAG, "can not get video height %s", new Object[]{e.getMessage()});
            return 0;
        }
    }
