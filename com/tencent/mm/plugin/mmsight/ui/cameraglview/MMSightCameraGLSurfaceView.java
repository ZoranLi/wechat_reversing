...
public class MMSightCameraGLSurfaceView extends GLSurfaceView {
    ...
    class a implements EGLConfigChooser {
        ...
        private int[] nMK = new int[]{12324, 4, 12323, 4, 12322, 4, 12352, this.EGL_OPENGL_ES2_BIT, 12344};
        protected int nML = 5;
        protected int nMM = 6;
        protected int nMN = 5;
        protected int nMO = 0;
        ...
        final /* synthetic */ MMSightCameraGLSurfaceView nMS;

        public a(MMSightCameraGLSurfaceView mMSightCameraGLSurfaceView) {
            this.nMS = mMSightCameraGLSurfaceView;
        }

        public final EGLConfig chooseConfig(EGL10 egl10, EGLDisplay eGLDisplay) {
            int[] iArr = new int[1];
            egl10.eglChooseConfig(eGLDisplay, this.nMK, null, 0, iArr);
            int i = iArr[0];
            if (i <= 0) {
                throw new IllegalArgumentException("No configs match configSpec");
            }
            EGLConfig[] eGLConfigArr = new EGLConfig[i];
            egl10.eglChooseConfig(eGLDisplay, this.nMK, eGLConfigArr, i, iArr);
        ...
        private static void b(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig[] eGLConfigArr) {
            w.i("GLConfigChooser", String.format("%d configurations", new Object[]{Integer.valueOf(eGLConfigArr.length)}));
            for (EGLConfig eGLConfig : eGLConfigArr) {
    ...
    public MMSightCameraGLSurfaceView(Context context, AttributeSet attributeSet) {
        ...
        this.nMH = new b();
        setRenderer(this.nMH);
        setRenderMode(0);
    }

    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        super.surfaceCreated(surfaceHolder);
        w.i("MicroMsg.MMSightCameraGLSurfaceView", "surfaceCreated: %s this: %s %s", new Object[]{surfaceHolder, this, Integer.valueOf(getId())});
    }

    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        super.surfaceDestroyed(surfaceHolder);
        w.i("MicroMsg.MMSightCameraGLSurfaceView", "surfaceDestroyed: %s this: %s", new Object[]{surfaceHolder, this});
    }

    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
        super.surfaceChanged(surfaceHolder, i, i2, i3);
        w.i("MicroMsg.MMSightCameraGLSurfaceView", "surfaceChanged, format: %s, w: %s, h: %s this: %s", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), this});
    }
}
