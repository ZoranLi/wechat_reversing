...
public final class m implements Runnable {
    public MediaFormat mfc;
    public MediaFormat mfd;
    public VideoMediaItem mfe;
    public a mff;
    public String path;
    public int position;
    ...
    L_0x0021:
        ...
        com.tencent.mm.sdk.platformtools.w.d(r4, r5);	 Catch:{ Exception -> 0x011c }
    L_0x002a:
        r0 = r0 + 1;
        goto L_0x0012;
    L_0x002d:
        ...
        com.tencent.mm.sdk.platformtools.w.d(r6, r7, r8);	 Catch:{ Exception -> 0x011c }
    ...
    L_0x004e:
        r5 = r12.mfc;	 Catch:{ Exception -> 0x011c }
        if (r5 != 0) goto L_0x0054;
    L_0x0052:
        r12.mfc = r4;	 Catch:{ Exception -> 0x011c }
    L_0x0054:
        r4 = r12.mfd;	 Catch:{ Exception -> 0x011c }
        if (r4 == 0) goto L_0x002a;
    L_0x0058:
        r4 = r12.mfc;	 Catch:{ Exception -> 0x011c }
        if (r4 == 0) goto L_0x002a;
    L_0x005c:
        r0 = r12.mfe;	 Catch:{ Exception -> 0x011c }
        if (r0 == 0) goto L_0x00ec;
    L_0x0060:
        r0 = r12.mfc;	 Catch:{ Exception -> 0x011c }
        if (r0 == 0) goto L_0x00d6;
    L_0x0064:
        r3 = r12.mfe;	 Catch:{ Exception -> 0x011c }
        r0 = r12.mfc;	 Catch:{ Exception -> 0x011c }
        r4 = "durationUs";
    ...
    L_0x0071:
        r0 = r1;
    L_0x0072:
        r3.hTi = r0;	 Catch:{ Exception -> 0x011c }
        r3 = r12.mfe;	 Catch:{ Exception -> 0x011c }
        r0 = r12.mfc;	 Catch:{ Exception -> 0x011c }
        r4 = "height";
        r0 = r0.containsKey(r4);	 Catch:{ Exception -> 0x011c }
    ...
    L_0x0081:
        r0 = r1;
    L_0x0082:
        r3.hTj = r0;	 Catch:{ Exception -> 0x011c }
        r3 = r12.mfe;	 Catch:{ Exception -> 0x011c }
        r0 = r12.mfc;	 Catch:{ Exception -> 0x011c }
        r4 = "width";
        r0 = r0.containsKey(r4);	 Catch:{ Exception -> 0x011c }
    ...
    L_0x0091:
        r0 = r1;
    L_0x0092:
        r3.hTk = r0;	 Catch:{ Exception -> 0x011c }
        r3 = r12.mfe;	 Catch:{ Exception -> 0x011c }
        r0 = r12.mfc;	 Catch:{ Exception -> 0x011c }
        r4 = "mime";
        r0 = r0.containsKey(r4);	 Catch:{ Exception -> 0x011c }
    ...
    L_0x00a1:
        r0 = "";
    L_0x00a4:
        r3.hTg = r0;	 Catch:{ Exception -> 0x011c }
        r3 = r12.mfe;	 Catch:{ Exception -> 0x011c }
        r0 = r12.mfc;	 Catch:{ Exception -> 0x011c }
        r4 = "bitrate";
        r0 = r0.containsKey(r4);	 Catch:{ Exception -> 0x011c }
    ...
    L_0x00c3:
        r0 = r1;
    L_0x00c4:
        r3.hTl = r0;	 Catch:{ Exception -> 0x011c }
        r3 = r12.mfe;	 Catch:{ Exception -> 0x011c }
        r0 = r12.mfc;	 Catch:{ Exception -> 0x011c }
        r4 = "frame-rate";
        r0 = r0.containsKey(r4);	 Catch:{ Exception -> 0x011c }
    ...
    L_0x00d6:
        r0 = r12.mfd;	 Catch:{ Exception -> 0x011c }
        if (r0 == 0) goto L_0x00ec;
    L_0x00da:
        r3 = r12.mfe;	 Catch:{ Exception -> 0x011c }
        r0 = r12.mfd;	 Catch:{ Exception -> 0x011c }
    ...
    L_0x00e7:
        r0 = "";
    L_0x00ea:
        r3.hTh = r0;	 Catch:{ Exception -> 0x011c }
    L_0x00ec:
        r2.release();
    L_0x00ef:
        r0 = r12.mff;
    ...
    L_0x010b:
        ...
        if (r5 == 0) goto L_0x0054;
    L_0x0114:
        r5 = r12.mfd;	 Catch:{ Exception -> 0x011c }
        if (r5 != 0) goto L_0x0054;
    L_0x0118:
        r12.mfd = r4;	 Catch:{ Exception -> 0x011c }
        goto L_0x0054;
    L_0x011c:
        r0 = move-exception;
        ...
        com.tencent.mm.sdk.platformtools.w.d(r3, r4, r5);	 Catch:{ all -> 0x0195 }
        r2.release();
        goto L_0x00ef;
    L_0x0139:
        r0 = r12.mfc;	 Catch:{ Exception -> 0x011c }
    ...
    L_0x019a:
        ...
        r0.<init>(r12);
        com.tencent.mm.sdk.platformtools.af.v(r0);
        goto L_0x010a;
        */
