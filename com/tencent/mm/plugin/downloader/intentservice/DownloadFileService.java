...
public class DownloadFileService extends IntentService {
    ...
    public void onCreate() {
        super.onCreate();
        d dVar = new d(this);
        dVar.a("Something Download").b("Download in progress").L(a.icon);
        startForeground(4657, dVar.build());
    }

    protected void onHandleIntent(Intent intent) {
        String string = intent.getExtras().getString(SlookSmartClipMetaTag.TAG_TYPE_URL);
        this.kGe = (ResultReceiver) intent.getParcelableExtra("receiver");
    ...
    L_0x0048:
        ...
        r5 = r11.kGf;	 Catch:{ ProtocolException -> 0x0073, MalformedURLException -> 0x00e0, IOException -> 0x0108 }
        r4 = r4 + r5;
        r11.kGf = r4;	 Catch:{ ProtocolException -> 0x0073, MalformedURLException -> 0x00e0, IOException -> 0x0108 }
        ...
        r6 = r11.kGg;	 Catch:{ ProtocolException -> 0x0073, MalformedURLException -> 0x00e0, IOException -> 0x0108 }
        if (r5 <= r6) goto L_0x0041;
    L_0x0063:
        r6 = "progress";
        r4.putInt(r6, r5);	 Catch:{ ProtocolException -> 0x0073, MalformedURLException -> 0x00e0, IOException -> 0x0108 }
        r6 = r11.kGe;	 Catch:{ ProtocolException -> 0x0073, MalformedURLException -> 0x00e0, IOException -> 0x0108 }
        ...
        r11.kGg = r5;	 Catch:{ ProtocolException -> 0x0073, MalformedURLException -> 0x00e0, IOException -> 0x0108 }
        goto L_0x0041;
    L_0x0073:
        r0 = move-exception;
        ...
        com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r3, r0, r4, r5);	 Catch:{ all -> 0x0132 }
    ...
    L_0x00a3:
        ...
        com.tencent.mm.sdk.platformtools.w.e(r3, r0);	 Catch:{ ProtocolException -> 0x0073, MalformedURLException -> 0x00e0, IOException -> 0x0108 }
    L_0x00b8:
    ...
    L_0x0158:
        ...
        goto L_0x00bf;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.downloader.intentservice.DownloadFileService.a(java.lang.String, java.io.File):void");
    }
}
