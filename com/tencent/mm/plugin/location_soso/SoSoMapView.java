...
public class SoSoMapView extends MapView implements d {
    ...
    private void init() {
        this.iController = new b() {
            public void setZoom(int i) {
                w.d(SoSoMapView.TAG, "set Zoom %d", new Object[]{Integer.valueOf(i)});
    ...
    public void zoomToSpan(double d, double d2, double d3, double d4) {
        ...
        if (d3 != 0.0d && d4 != 0.0d) {
            ...
            g map = getController().xbk.getMap();
            ...
            map.mapContext.c().a(com.tencent.tencentmap.mapsdk.map.b.a(new Builder().include(latLng).include(new LatLng((d5 / 2.0d) + map.getMapCenter().getLatitude(), map.getMapCenter().getLongitude() - (d6 / 2.0d))).build(), 10).xbi);
            getController().c(new GeoPoint((int) (1000000.0d * d), (int) (1000000.0d * d2)));
        }
    }
    ...
    public Point getPointByGeoPoint(double d, double d2) {
        ...
        PointF a = getProjection().xbo.a(com.tencent.mapsdk.rastercore.f.a.a(new GeoPoint((int) (d * 1000000.0d), (int) (d2 * 1000000.0d))));
        point.x = (int) a.x;
        point.y = (int) a.y;
        return point;
    }
    ...
    public float metersToEquatorPixels(double d) {
        return getProjection().xbo.a((float) d);
    }
