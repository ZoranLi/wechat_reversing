...
public final class b extends com.tencent.mm.plugin.backup.f.b {
    ...
    public b(String str, int i, LinkedList<eh> linkedList, String str2, f fVar, byte[] bArr) {
        this.jHw.jOf = str;
        this.jHw.jOg = i;
        this.type = i;
        if (i == 1) {
    ...
    public final boolean abt() {
                ...
                if (i3 > 0 && obj == null) {
                    if (!bg.mA(this.filePath)) {
                        ...
                        if (str.startsWith(c.xi())) {
                            ...
                            com.tencent.mm.storage.a.c ub = ((com.tencent.mm.plugin.emoji.b.c) h.j(com.tencent.mm.plugin.emoji.b.c.class)).getEmojiMgr().ub(r4);
                            if (ub == null || (ub.field_reserved4 & com.tencent.mm.storage.a.c.uLn) != com.tencent.mm.storage.a.c.uLn) {
                                ...
                                obj = new byte[i2];
                                System.arraycopy(((com.tencent.mm.plugin.emoji.b.c) h.j(com.tencent.mm.plugin.emoji.b.c.class)).getEmojiMgr().g(ub), this.offset, obj, 0, i2);
                                i3 = i4;
                            }
                        }
                    }
        ...
        this.jHw.jOj = this.start + bArr.length;
