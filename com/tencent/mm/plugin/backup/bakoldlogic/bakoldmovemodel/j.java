...
public final class j extends k implements com.tencent.mm.network.j {
    ...
    public j(LinkedList<me> linkedList, String str) {
        ...
        aVar.sZy = new com.tencent.mm.protocal.k.a(this) {
            ...
            public final boolean a(PByteArray pByteArray, int i, byte[] bArr, byte[] bArr2, int i2) {
                ...
                if (i == 1000) {
                    byte[] bArr3 = aVar.sZz;
                    w.d("MicroMsg.NetSceneBakChatCreateQRCodeOffline", "BakMove key:" + bArr3);
                    if (!acVar.bHv()) {
                        bArr3 = new byte[0];
                    }
                    if (bg.bm(bArr3)) {
                        w.e("MicroMsg.NetSceneBakChatCreateQRCodeOffline", "dksession jType %d session should not null", new Object[]{Integer.valueOf(i)});
                        return false;
                    }
                    if (MMProtocalJni.pack(aVar.zh(), pByteArray, bArr3, bArr, aVar.sZv, (int) j, 1000, acVar.ver, acVar.tal.getBytes(), acVar.tam.getBytes(), bArr2, i2)) {
                        w.d("MicroMsg.NetSceneBakChatCreateQRCodeOffline", "reqToBuf using protobuf ok, len:%d, flag:%d", new Object[]{Integer.valueOf(pByteArray.value.length), Integer.valueOf(i2)});
                        return true;
                    }
                }
                return false;
    ...
    public final void a(int i, int i2, int i3, String str, p pVar, byte[] bArr) {
        w.i("MicroMsg.NetSceneBakChatCreateQRCodeOffline", "err: %d, %d, %s", new Object[]{Integer.valueOf(i2), Integer.valueOf(i3), str});
        if (i2 == 0 && i3 == 0) {
            w.i("MicroMsg.NetSceneBakChatCreateQRCodeOffline", "onGYNetEnd QRCodeUrl:%s", new Object[]{((b) pVar.zg()).sZr.thZ});
