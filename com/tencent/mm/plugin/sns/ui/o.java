...
public final class o implements y {
    ...
    public final boolean a(int i, int i2, b.a.d.i iVar, String str, List<String> list, ajq com_tencent_mm_protocal_c_ajq, int i3, boolean z, List<String> list2, PInt pInt, String str2, int i4, int i5) {
        ...
        boolean z2 = false;
        if (!bg.mA(this.fOa)) {
            z2 = awVar.a(FileOp.c(this.fOa, 0, -1), this.qqQ, this.title, this.qqO, this.qqP);
        } else if (!(bg.mA(this.qqI) || n.GR() == null)) {
            n.GR();
            Bitmap gS = com.tencent.mm.ah.b.gS(this.qqI);
            if (gS != null) {
                z2 = awVar.a(d.L(gS), this.qqQ, this.title, this.qqO, this.qqP);
            }
        }
        if (!z2) {
            w.i("MicroMsg.EmojiShareWidget", "set userData user imgurl ");
            z2 = awVar.a(this.qqI, this.qqI, this.qqQ, this.qqO, this.qqP);
        }
        if (!z2) {
        ...
        ae.beH().bdz();
        this.fCi.finish();
        String ui = ((c) h.j(c.class)).getEmojiMgr().ui(this.qqP);
        com.tencent.mm.plugin.report.service.g.oUh.i(10993, new Object[]{Integer.valueOf(1), ui});
        return false;
    }
