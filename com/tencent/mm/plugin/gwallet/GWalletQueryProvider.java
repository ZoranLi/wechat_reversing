...
public class GWalletQueryProvider extends ContentProvider {
    public static final String[] tl = new String[]{"_id", "product_id", "full_price", "product_state", "price_currency", "price_amount"};
    private final String TAG = "MicroMsg.GWalletQueryProvider";
    private Context mContext = null;
    private b mKl = null;
    private boolean mKm;
    private boolean mKn;
    private ArrayList<String> mKo;
    private ArrayList<String> mKp;
    private int mKq;

    static /* synthetic */ void d(GWalletQueryProvider gWalletQueryProvider) {
        if (gWalletQueryProvider.mKl != null) {
            gWalletQueryProvider.mKl.a(gWalletQueryProvider.mKp, new c(gWalletQueryProvider) {
                final /* synthetic */ GWalletQueryProvider mKr;
                ...
                public final void a(com.tencent.mm.plugin.gwallet.a.c cVar, Intent intent) {
                    w.d("MicroMsg.GWalletQueryProvider", "query detail done! Result " + cVar);
                    this.mKr.mKn = true;
                    this.mKr.mKo = intent.getStringArrayListExtra("RESPONSE_QUERY_DETAIL_INFO");
                    this.mKr.mKq = intent.getIntExtra("RESPONSE_CODE", 0);
                }
            });
        }
    }
    ...
    public android.database.Cursor query(android.net.Uri r16, java.lang.String[] r17, java.lang.String r18, java.lang.String[] r19, java.lang.String r20) {
        ...
        com.tencent.mm.sdk.platformtools.w.d(r2, r3);	 Catch:{ all -> 0x0025 }
    ...
    L_0x0028:
        ...
        r2.<init>(r3);	 Catch:{ all -> 0x0025 }
        r15.mKl = r2;	 Catch:{ all -> 0x0025 }
        r2 = 1;
        r15.mKm = r2;	 Catch:{ all -> 0x0025 }
        r2 = 0;
        r15.mKn = r2;	 Catch:{ all -> 0x0025 }
        r2 = new java.util.ArrayList;	 Catch:{ all -> 0x0025 }
        r2.<init>();	 Catch:{ all -> 0x0025 }
        r15.mKp = r2;	 Catch:{ all -> 0x0025 }
        r0 = r19;
    ...
    L_0x006f:
        r4 = r15.mKm;	 Catch:{ all -> 0x0025 }
        if (r4 == 0) goto L_0x008c;
    L_0x0073:
        r4 = r15.mKn;	 Catch:{ all -> 0x0025 }
        if (r4 != 0) goto L_0x008c;
    L_0x0077:
        r4 = 100;
    ...
    L_0x0080:
        ...
        com.tencent.mm.sdk.platformtools.w.e(r5, r4);	 Catch:{ all -> 0x0025 }
        goto L_0x0069;
    L_0x008c:
        r4 = r15.mKm;	 Catch:{ all -> 0x0025 }
    ...
    L_0x0090:
        ...
        r2 = tl;	 Catch:{ all -> 0x0025 }
        r3.<init>(r2);	 Catch:{ all -> 0x0025 }
        r2 = r15.mKp;	 Catch:{ all -> 0x0025 }
    ...
    L_0x013a:
        ...
        r2 = r15.mKq;	 Catch:{ all -> 0x0025 }
        if (r2 != 0) goto L_0x020b;
    L_0x014e:
        r2 = 0;
        r3 = r15.mKo;	 Catch:{ all -> 0x0025 }
    ...
    L_0x0160:
        ...
        r2 = (java.lang.String) r2;	 Catch:{ all -> 0x0025 }
        r5 = com.tencent.mm.sdk.platformtools.bg.mA(r2);	 Catch:{ all -> 0x0025 }
    ...
    L_0x016c:
        ...
        r3 = r15.mKp;	 Catch:{ JSONException -> 0x024e }
    ...
    L_0x01bc:
        ...
        com.tencent.mm.sdk.platformtools.w.d(r5, r3);	 Catch:{ all -> 0x0025 }
    L_0x01c6:
        r3 = r2;
        goto L_0x015a;
    L_0x01c8:
