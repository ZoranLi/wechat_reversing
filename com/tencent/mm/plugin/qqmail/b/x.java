...
public final class x extends h {
    ...
    public final com.tencent.mm.plugin.qqmail.b.h.c a(java.lang.String r15, java.lang.String r16, com.tencent.mm.plugin.qqmail.b.h.b r17, com.tencent.mm.plugin.qqmail.b.h.a r18) {
        ...
        r3 = 0;
        r0 = r17;
        r2 = r0.ozD;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        if (r2 != 0) goto L_0x0187;
    L_0x002e:
        r0 = r17;
        r2 = r0.ozE;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
    L_0x0032:
        r0 = r16;
        r2 = com.tencent.mm.plugin.qqmail.b.h.c(r15, r0, r2);	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r6 = 0;
        r2 = com.tencent.mm.network.b.a(r2, r6);	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r14.oBf = r2;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r2 = r14.oBf;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r6 = jbJ;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r2.setConnectTimeout(r6);	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r6 = r14.oBf;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r0 = r17;
        r2 = r0.ozD;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
    ...
    L_0x0051:
        ...
        r2 = r14.oBf;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r2.MA();	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r2 = r14.oBf;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r2.MB();	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r2 = r14.oBf;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r6 = 0;
        r2.setUseCaches(r6);	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r2 = r14.oBf;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r6 = "User-Agent";
        r7 = lRl;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        ...
        r6 = "Cookie";
        r0 = r17;
        r7 = r0.ozF;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r7 = com.tencent.mm.plugin.qqmail.b.h.G(r7);	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r2.setRequestProperty(r6, r7);	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        r2 = r14.oBf;	 Catch:{ Exception -> 0x0288, all -> 0x0279 }
        ...
        r0 = r17;
        r2 = r0.ozD;	 Catch:{ Exception -> 0x028b, all -> 0x027d }
        r5 = 1;
    ...
    L_0x00be:
        ...
        r2 = r14.oBf;	 Catch:{ Exception -> 0x028b, all -> 0x027d }
        r5 = r2.getResponseCode();	 Catch:{ Exception -> 0x028b, all -> 0x027d }
        r2 = r14.oBf;	 Catch:{ Exception -> 0x028f, all -> 0x027d }
        r3 = "set-cookie";
    ...
    L_0x014b:
        ...
        r18.aUn();	 Catch:{ Exception -> 0x0156, all -> 0x01a7 }
        goto L_0x0145;
    L_0x0156:
        r2 = move-exception;
        r3 = r5;
    ...
    L_0x015a:
        ...
        com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r6, r2, r7, r8);	 Catch:{ all -> 0x0284 }
    ...
    L_0x01bf:
        ...
        r9 = com.tencent.mm.plugin.qqmail.b.h.CO(r9);	 Catch:{ Exception -> 0x0156, all -> 0x01a7 }
    ...
    L_0x01ca:
        ...
        com.tencent.mm.sdk.platformtools.w.d(r2, r3);	 Catch:{ Exception -> 0x0156, all -> 0x01a7 }
    ...
    L_0x021d:
        ...
        com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r3, r2, r5, r7);
        goto L_0x01fb;
    L_0x022b:
        r2 = move-exception;
        r3 = "MicroMsg.URLConnectionUtil";
        ...
        com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r3, r2, r5, r6);
        goto L_0x0200;
    L_0x0239:
    ...
    L_0x023d:
        ...
        r7 = 0;
        r7 = new java.lang.Object[r7];
        com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r5, r3, r6, r7);
        goto L_0x0176;
    L_0x024c:
        r3 = move-exception;
        ...
        r6 = 0;
        r6 = new java.lang.Object[r6];
        com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r4, r3, r5, r6);
        goto L_0x017b;
    L_0x025b:
        r3 = move-exception;
        r5 = "MicroMsg.URLConnectionUtil";
    ...
    private static void a(b bVar, OutputStream outputStream) {
        if (bVar.ozE != null) {
            ...
            for (String str : bVar.ozE.keySet()) {
                stringBuilder.append(obj != null ? "" : "&").append(URLEncoder.encode(str, ProtocolPackage.ServerEncoding)).append('=').append(URLEncoder.encode((String) bVar.ozE.get(str), ProtocolPackage.ServerEncoding));
                obj = null;
            }
