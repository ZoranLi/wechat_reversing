...
class NetStatRuler extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        textPaint.setTextSize((float) getContext().getResources().getDimensionPixelSize(R.f.aXX));
        Rect rect = new Rect();
        getDrawingRect(rect);
        ...
        canvas.drawText(bg.ew((long) ((NetStatUnit.max * 2) / 3)), paddingLeft, f, textPaint);
        canvas.drawText(bg.ew((long) (NetStatUnit.max / 3)), paddingLeft, f2, textPaint);
        canvas.drawText(bg.ew(0), paddingLeft, f3, textPaint);
    }
}
