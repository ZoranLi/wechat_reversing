...
public class AppBrandSOSUI extends FTSSOSMoreWebViewUI {
    ...
    private static class GetLocationGeoTask extends MainProcessTask {
        ...
        public final void PM() {
            c.Gk().a(new a(this) {
                final /* synthetic */ GetLocationGeoTask jjE;
                ...
                public final boolean a(boolean z, float f, float f2, int i, double d, double d2, double d3) {
                    c.Gk().c(this);
                    w.d("MicroMsg.AppBrandSOSUI", "onGetLocation(%s, %s, %s, %s, %s, %s)", new Object[]{Boolean.valueOf(z), Float.valueOf(f), Float.valueOf(f2), Integer.valueOf(i), Double.valueOf(d), Double.valueOf(d2)});
                    return false;
                }
            }, true);
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        p.post(new Runnable(this) {
            final /* synthetic */ AppBrandSOSUI jjD;
        ...
        w.i("MicroMsg.AppBrandSOSUI", "onCreate oreh report weAppSearchClickStream(13929) statSessionId:%s", new Object[]{this.jjC});
    ...
    public final void a(String str, String str2, List<com.tencent.mm.ui.fts.widget.a.b> list, FTSEditTextView.b bVar) {
        ...
        try {
            ...
            w.e("MicroMsg.AppBrandSOSUI", "refresh keyword id error : %s", new Object[]{e});
        }
    ...
    protected final void bE(View view) {
        ...
        findViewById.setOnClickListener(new OnClickListener(this) {
            ...
            public final void onClick(View view) {
                if (!TextUtils.isEmpty(this.jjD.jjB)) {
                    Intent intent = new Intent();
                    intent.putExtra("showShare", false);
                    intent.putExtra("rawUrl", this.jjD.jjB);
