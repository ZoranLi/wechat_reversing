...
public final class p implements c {
    ...
    public final boolean a(d dVar, Canvas canvas, JSONArray jSONArray) {
        ...
        if ("linear".equalsIgnoreCase(optString)) {
            ...
            dVar.iDe.setShader(new LinearGradient((float) a, (float) a2, (float) a3, (float) a4, iArr, fArr, TileMode.CLAMP));
            ...
            a3 = h.a(optJSONArray, 2);
            if (a3 <= 0) {
                w.i("MicroMsg.Canvas.SetFillStyleAction", "setFillStyle(radial) failed, sr(%s) <= 0.", new Object[]{Integer.valueOf(a3)});
                return false;
            }
            ...
            dVar.iDe.setShader(new RadialGradient((float) a, (float) a2, (float) a3, iArr2, fArr2, TileMode.CLAMP));
        } else if ("normal".equalsIgnoreCase(optString)) {
            optJSONArray = jSONArray.optJSONArray(1);
            if (optJSONArray == null || optJSONArray.length() < 4) {
                return false;
            }
            dVar.iDe.setColor(h.j(optJSONArray));
        }
        return true;
    }
}
