...
public final class b {
    public static final String kxq = new String(Character.toChars(91));
    private static HashMap<String, c> mQV = new HashMap();

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.ArrayList<com.tencent.mm.plugin.ipcall.a.g.c> aEM() {
        /*
        r4 = 0;
        r15 = 2;
        r14 = 1;
        ...
        r0 = com.tencent.mm.pluginsdk.i.a.aT(r0, r1);
    ...
    L_0x006d:
        ...
        com.tencent.mm.sdk.platformtools.w.d(r0, r3, r4);	 Catch:{ Exception -> 0x00f6 }
    ...
    L_0x00ab:
        r0 = r7.mQW;	 Catch:{ Exception -> 0x00f6 }
    ...
    L_0x00b7:
        ...
        r0 = com.tencent.mm.sdk.platformtools.bg.mA(r0);	 Catch:{ Exception -> 0x00f6 }
        if (r0 != 0) goto L_0x00f2;
    L_0x00bf:
        r0 = r7.field_contactId;	 Catch:{ Exception -> 0x00f6 }
    ...
    L_0x00c7:
        ...
        r10 = r7.mQW;	 Catch:{ Exception -> 0x00f6 }
        r10 = r10.size();	 Catch:{ Exception -> 0x00f6 }
        if (r10 <= 0) goto L_0x00f2;
    L_0x00d7:
        r10 = r0.mQW;	 Catch:{ Exception -> 0x00f6 }
        r11 = r7.mQW;	 Catch:{ Exception -> 0x00f6 }
        r12 = 0;
        r11 = r11.get(r12);	 Catch:{ Exception -> 0x00f6 }
        r10 = r10.contains(r11);	 Catch:{ Exception -> 0x00f6 }
        if (r10 != 0) goto L_0x00f2;
    L_0x00e6:
        r0 = r0.mQW;	 Catch:{ Exception -> 0x00f6 }
        r7 = r7.mQW;	 Catch:{ Exception -> 0x00f6 }
        r10 = 0;
    ...
    L_0x00f6:
        ...
        com.tencent.mm.sdk.platformtools.w.e(r3, r4, r5);	 Catch:{ all -> 0x014a }
        r1.close();
    L_0x0118:
        r0 = r2.values();
        r6.addAll(r0);
    ...
    L_0x014f:
        ...
        goto L_0x0118;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.ipcall.a.g.b.aEM():java.util.ArrayList<com.tencent.mm.plugin.ipcall.a.g.c>");
    }

    public static HashMap<String, c> aEN() {
        return mQV;
    }

    public static HashMap<String, c> aEO() {
        aEM();
        return mQV;
    }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.ArrayList<java.lang.String> ys(java.lang.String r8) {
        /*
        r2 = 0;
        r4 = 1;
        r5 = 0;
    ...
    L_0x0058:
        ...
        com.tencent.mm.sdk.platformtools.w.e(r2, r3, r4);	 Catch:{ all -> 0x0080 }
        r1.close();
    L_0x007a:
        r0 = r6;
        goto L_0x001f;
    ...
    L_0x0080:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.ipcall.a.g.b.ys(java.lang.String):java.util.ArrayList<java.lang.String>");
    }

    private static c a(Cursor cursor, int i, int i2, int i3) {
        String str = null;
        if (a.aT(ab.getContext(), "android.permission.READ_CONTACTS")) {
            c cVar = new c();
            cVar.mQW = new ArrayList();
            String string = cursor.getString(i);
            String string2 = cursor.getString(i2);
            String string3 = cursor.getString(i3);
            cVar.field_contactId = string;
            cVar.field_systemAddressBookUsername = string2;
            if (!(bg.mA(string3) || cVar.mQW.contains(string3))) {
                cVar.mQW.add(string3);
            }
            if (bg.mA(cVar.field_systemAddressBookUsername) && cVar.mQW.size() > 0) {
                cVar.field_systemAddressBookUsername = (String) cVar.mQW.get(0);
            }
            Iterator it = cVar.mQW.iterator();
            string2 = str;
            while (it.hasNext()) {
                string = com.tencent.mm.plugin.ipcall.b.a.yP((String) it.next());
                if (bg.mA(string)) {
                    string = string2;
            ...
            if (bg.mA(cVar.field_systemAddressBookUsername)) {
                cVar.field_sortKey = "";
            } else {
                try {
                    str = c.mp(cVar.field_systemAddressBookUsername);
                } catch (Exception e) {
                    w.d("MicroMsg.IPCallAddressBookInfoExtracter", "getFullSpell error: %s, class: %s", new Object[]{e.getMessage(), e.getClass().getSimpleName()});
                }
                if (bg.mA(str)) {
                    cVar.field_sortKey = "";
                    ...
                    cVar.field_sortKey = kxq + str.toUpperCase();
                }
            }
            return cVar;
        }
