...
public final class i {
    ...
    public final synchronized boolean a(byte[] r9, android.graphics.Point r10, android.graphics.Rect r11, boolean r12) {
        ...
        r2 = com.tencent.mm.compatible.d.c.rh();	 Catch:{ all -> 0x00ff }
    ...
    L_0x00b7:
        ...
        if (r2 <= r3) goto L_0x003a;
    L_0x00bd:
        r2 = new com.tencent.mm.plugin.scanner.util.c;	 Catch:{ all -> 0x00ff }
        r3 = r10.x;	 Catch:{ all -> 0x00ff }
        r4 = r10.y;	 Catch:{ all -> 0x00ff }
        r2.<init>(r9, r3, r4, r1);	 Catch:{ all -> 0x00ff }
        r2 = r2.aYX();	 Catch:{ all -> 0x00ff }
        if (r2 == 0) goto L_0x003a;
    L_0x00cc:
        r3 = r8.isInit;	 Catch:{ all -> 0x00ff }
        if (r3 != 0) goto L_0x0117;
    L_0x00d0:
        r3 = com.tencent.mm.compatible.d.c.rh();	 Catch:{ all -> 0x00ff }
    ...
    L_0x00ea:
        ...
        com.tencent.mm.sdk.platformtools.w.e(r2, r3, r4);	 Catch:{ all -> 0x00ff }
        goto L_0x003a;
    L_0x00ff:
        r0 = move-exception;
        monitor-exit(r8);
    ...
    L_0x0117:
        r0 = com.tencent.mm.sdk.platformtools.bg.NA();	 Catch:{ all -> 0x00ff }
        r3 = com.tencent.mm.compatible.d.c.rh();	 Catch:{ all -> 0x00ff }
        r4 = com.tencent.mm.plugin.scanner.util.b.a.pdg;	 Catch:{ all -> 0x00ff }
        ...
        r4 = new java.lang.Object[r4];	 Catch:{ all -> 0x00ff }
        r5 = 0;
        r6 = com.tencent.mm.plugin.scanner.util.b.a.pdg;	 Catch:{ all -> 0x00ff }
        r7 = 0;
        ...
        r4[r5] = r6;	 Catch:{ all -> 0x00ff }
        r5 = 2;
        r0 = com.tencent.mm.sdk.platformtools.bg.aB(r0);	 Catch:{ all -> 0x00ff }
        r0 = java.lang.Long.valueOf(r0);	 Catch:{ all -> 0x00ff }
        r4[r5] = r0;	 Catch:{ all -> 0x00ff }
        com.tencent.mm.sdk.platformtools.w.d(r2, r3, r4);	 Catch:{ all -> 0x00ff }
        r0 = com.tencent.mm.plugin.scanner.util.b.a.pdg;	 Catch:{ all -> 0x00ff }
        r1 = 1;
        r0 = r0[r1];	 Catch:{ all -> 0x00ff }
        if (r0 == 0) goto L_0x0167;
    L_0x015a:
        r0 = java.lang.System.currentTimeMillis();	 Catch:{ all -> 0x00ff }
        r8.pee = r0;	 Catch:{ all -> 0x00ff }
    L_0x0160:
        r0 = com.tencent.mm.plugin.scanner.util.b.a.pdg;	 Catch:{ all -> 0x00ff }
        r1 = 1;
        r0 = r0[r1];	 Catch:{ all -> 0x00ff }
    ...
    L_0x0183:
        ...
        com.tencent.mm.sdk.platformtools.w.d(r2, r3);	 Catch:{ all -> 0x00ff }
        r2 = com.tencent.mm.plugin.scanner.util.b.a.pdg;	 Catch:{ all -> 0x00ff }
        r3 = 1;
        r4 = 1;
        ...
        goto L_0x0160;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.scanner.util.i.a(byte[], android.graphics.Point, android.graphics.Rect, boolean):boolean");
    }
