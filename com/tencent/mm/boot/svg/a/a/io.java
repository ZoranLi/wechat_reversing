    ...
    protected final int b(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                a.setColor(-3487030);
                c = c.a(c, -1.0f, 0.0f, 140.0274f, 0.0f, 1.0f, 0.0f);
                d.reset();
                d.setValues(c);
                canvas.concat(d);
                Path h = c.h(looper);
                h.moveTo(63.00885f, 34.0f);
                h.lineTo(63.00885f, 57.0f);
                h.lineTo(77.018555f, 57.0f);
                h.lineTo(77.018555f, 34.0f);
                h.lineTo(63.00885f, 34.0f);
                h.close();
                h.moveTo(64.0293f, 35.0f);
                h.lineTo(64.0293f, 54.0f);
                h.lineTo(75.99579f, 53.90808f);
                h.lineTo(75.99579f, 35.0f);
                h.lineTo(64.0293f, 35.0f);
                h.close();
