...
public final class v {
    ...
    public static class a {
        public static int G(Context context, String str) {
            ...
            try {
                ...
                w.printErrStackTrace("MicroMsg.YYBMarketVerify", e, "", new Object[0]);
            ...
            try {
                ...
                w.printErrStackTrace("MicroMsg.YYBMarketVerify", e2, "", new Object[0]);
                Object obj = context2;
            }
            if (a == null) {
                return 0;
            ...
            try {
                ...
                w.printErrStackTrace("MicroMsg.YYBMarketVerify", e3, "", new Object[0]);
                eventType = 0;
            }
            while (eventType != 1) {
                switch (eventType) {
                    case 2:
                        ...
                        if (!TextUtils.isEmpty(name) && name.equals("manifest")) {
                            Object a2 = a(a.getAttributeValue("http://schemas.android.com/apk/res/android", DownloadInfoColumns.VERSIONCODE), resources);
                            if (TextUtils.isEmpty(a2)) {
                                return 0;
                            }
                            return u.getInt(a2, 0);
                        }
                }
                try {
                    eventType = a.nextToken();
                } catch (Throwable e4) {
                    w.printErrStackTrace("MicroMsg.YYBMarketVerify", e4, "", new Object[0]);
                } catch (Throwable e42) {
                    w.printErrStackTrace("MicroMsg.YYBMarketVerify", e42, "", new Object[0]);
                }
            }
            return 0;
        }
    ...
    public static class b {
        ...
        L_0x004f:
            ...
            com.tencent.mm.sdk.platformtools.w.d(r7, r6);	 Catch:{ Exception -> 0x00bb, all -> 0x016a }
            ...
            com.tencent.mm.sdk.platformtools.w.d(r6, r7);	 Catch:{ Exception -> 0x00bb, all -> 0x016a }
        ...
        L_0x00be:
            ...
            com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r3, r0, r4, r5);	 Catch:{ all -> 0x00cb }
        ...
        L_0x00e8:
            ...
            r0 = H(r0);	 Catch:{ Exception -> 0x0175, all -> 0x016d }
            r2.<init>(r0);	 Catch:{ Exception -> 0x0175, all -> 0x016d }
            r0 = r2.getBytes();	 Catch:{ Exception -> 0x0175, all -> 0x016d }
            r0 = com.tencent.mm.sdk.platformtools.aa.bj(r0);	 Catch:{ Exception -> 0x0175, all -> 0x016d }
        ...
        L_0x0106:
            ...
            com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r2, r1, r4, r5);
            goto L_0x0102;
        L_0x0113:
            r1 = move-exception;
            r2 = "MicroMsg.YYBMarketVerify";
        ...
        L_0x017c:
            ...
            goto L_0x00e6;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.platformtools.v.b.m(java.io.File):java.lang.String");
        }
    ...
    public static boolean a(Context context, ArrayList<c> arrayList, boolean z) {
        ...
        while (it.hasNext()) {
            c cVar = (c) it.next();
            if (!TextUtils.isEmpty(cVar.fwP)) {
                String str;
                String replace;
                String str2 = cVar.fwP;
                    ...
                    for (String replace2 : arrayList2) {
                        ...
                        if (file.exists()) {
                            try {
                                ...
                                if (z) {
                                    PackageInfo packageInfo = context.getPackageManager().getPackageInfo(cVar.fwP, 64);
                                    if (packageInfo.signatures.length > 0) {
                                        replace2 = aa.Pq(packageInfo.signatures[packageInfo.signatures.length - 1].toCharsString());
                                    }
                                    obj2 = replace2;
                                } else {
                                ...
                                objArr[2] = cVar.ikb;
                                objArr[3] = obj2;
                                boolean z2 = !TextUtils.isEmpty(obj2) && obj2.equalsIgnoreCase(cVar.ikb);
                                objArr[4] = Boolean.valueOf(z2);
                                objArr[5] = Long.valueOf(System.currentTimeMillis() - currentTimeMillis);
                                w.i(str3, str4, objArr);
                                if (!TextUtils.isEmpty(obj2) && obj2.equalsIgnoreCase(cVar.ikb)) {
                                    int i2;
                                    currentTimeMillis = System.currentTimeMillis();
                                    if (z) {
                                        i2 = context.getPackageManager().getPackageInfo(cVar.fwP, 0).versionCode;
                                    } else {
                                        i2 = a.G(context, cVar.fwP);
                                    }
                                    ...
                                    objArr[0] = Boolean.valueOf(z);
                                    objArr[1] = cVar.fwP;
                                    objArr[2] = Integer.valueOf(cVar.ika);
                                    objArr[3] = Integer.valueOf(i2);
                                    objArr[4] = Boolean.valueOf(i2 <= cVar.ika);
                                    objArr[5] = Long.valueOf(System.currentTimeMillis() - currentTimeMillis);
                                    w.i(str3, str4, objArr);
                                    if (i2 <= cVar.ika) {
                                        return true;
