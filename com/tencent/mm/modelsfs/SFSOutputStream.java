...
public class SFSOutputStream extends OutputStream {
    private StackTraceElement[] hRz = Thread.currentThread().getStackTrace();
    ...
    protected void finalize() {
        if (this.mNativePtr != 0) {
            ...
            for (StackTraceElement stackTraceElement : this.hRz) {
                stringBuilder.append(stackTraceElement.toString()).append('\n');
            }
            w.e("MicroMsg.SFSOutputStream", stringBuilder.toString());
            close();
        }
        super.finalize();
    }
