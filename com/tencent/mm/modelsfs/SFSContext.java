...
public class SFSContext {
    ...
    public SFSContext(Builder builder) {
    ...
    public final InputStream openRead(String str) {
        ...
        if (nativeOpenRead == 0) {
            ...
            return new d(nativeOpenRead, kr);
        } else {
            return new SFSInputStream(nativeOpenRead);
        }
    }

    public final OutputStream ah(String str, String str2) {
        if (this.mNativePtr == 0) {
            throw new IllegalArgumentException("Reuse already released SFSContext.");
        }
    ...
    public final List<FileEntry> kt(String str) {
        if (this.mNativePtr == 0) {
            throw new IllegalArgumentException("Reuse already released SFSContext.");
        }
    ...
    public final FileEntry ku(String str) {
        if (this.mNativePtr == 0) {
            throw new IllegalArgumentException("Reuse already released SFSContext.");
        }
        if (f.kp(str)) {
