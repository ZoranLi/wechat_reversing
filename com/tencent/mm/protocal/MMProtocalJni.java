...
public final class MMProtocalJni {
    ...
    public static native boolean pack(byte[] bArr, PByteArray pByteArray, byte[] bArr2, byte[] bArr3, String str, int i, int i2, int i3, byte[] bArr4, byte[] bArr5, byte[] bArr6, int i4);

    public static native boolean packDoubleHybrid(PByteArray pByteArray, byte[] bArr, String str, int i, int i2, int i3, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, int i4);

    public static native boolean packHybrid(PByteArray pByteArray, byte[] bArr, String str, int i, int i2, int i3, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, int i4);
    ...
    public static native boolean unpack(PByteArray pByteArray, byte[] bArr, byte[] bArr2, PByteArray pByteArray2, PInt pInt, PInt pInt2, PInt pInt3);
