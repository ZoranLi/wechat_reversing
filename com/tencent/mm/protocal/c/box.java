...
public final class box extends avp {
    public String tlt;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            box com_tencent_mm_protocal_c_box = (box) objArr[1];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_box.tZe = enVar;
                    }
                    return 0;
                case 2:
                    com_tencent_mm_protocal_c_box.tlt = aVar3.xmD.readString();
                    return 0;
                default:
                    return -1;
            }
