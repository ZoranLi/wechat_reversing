...
public final class jm extends avp {
    public int kAC;
    public String kAD;
    public int tpv;
    public b tpw;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            if (this.tpw != null) {
                r0 += a.a.a.a.a(4, this.tpw);
            }
            return r0 + a.a.a.a.eL(5, this.tpv);
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    jmVar.kAC = aVar3.xmD.mL();
                    return 0;
                case 3:
                    jmVar.kAD = aVar3.xmD.readString();
                    return 0;
                case 4:
                    jmVar.tpw = aVar3.cic();
                    return 0;
                case 5:
                    jmVar.tpv = aVar3.xmD.mL();
                    return 0;
                default:
                    return -1;
            }
