...
public final class atp extends avp {
    public atq tXC;
    public int tXE;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_atp.tXC = com_tencent_mm_protocal_c_atq;
                    }
                    return 0;
                case 2:
                    com_tencent_mm_protocal_c_atp.tXE = aVar3.xmD.mL();
                    return 0;
                case 3:
                    En = aVar3.En(intValue);
                    size = En.size();
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_atp.tZe = com_tencent_mm_protocal_c_atq;
                    }
                    return 0;
                default:
                    return -1;
