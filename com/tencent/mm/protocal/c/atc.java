...
public final class atc extends avh {
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            return r0 + a.a.a.a.eL(4, this.time_stamp);
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_atc.tYN = emVar;
                    }
                    return 0;
                case 2:
                    com_tencent_mm_protocal_c_atc.tkL = aVar3.xmD.readString();
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_atc.tkF = aVar3.xmD.readString();
                    return 0;
                case 4:
                    com_tencent_mm_protocal_c_atc.time_stamp = aVar3.xmD.mL();
                    return 0;
                default:
                    return -1;
            }
