...
public final class bcd extends avp {
    public int tlZ;
    public avw tob;
    public lv toe;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bcd.tZe = enVar;
                    }
                    return 0;
                case 2:
                    En = aVar3.En(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bcd.toe = enVar;
                    }
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_bcd.tlZ = aVar3.xmD.mL();
                    return 0;
                case 4:
                    En = aVar3.En(intValue);
                    size = En.size();
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bcd.tob = enVar;
                    }
                    return 0;
                default:
                    return -1;
