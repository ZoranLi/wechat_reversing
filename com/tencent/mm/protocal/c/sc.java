...
public final class sc extends a {
    public LinkedList<sb> tzv = new LinkedList();

    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ((a.a.a.c.a) objArr[0]).d(1, 8, this.tzv);
            return 0;
        } else if (i == 1) {
            return a.a.a.a.c(1, 8, this.tzv) + 0;
        } else {
            byte[] bArr;
            if (i == 2) {
                bArr = (byte[]) objArr[0];
                ...
                switch (intValue) {
                    case 1:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            for (boolean z = true; z; z = sbVar.a(aVar3, sbVar, a.a(aVar3))) {
                            }
                            scVar.tzv.add(sbVar);
                        }
                        return 0;
