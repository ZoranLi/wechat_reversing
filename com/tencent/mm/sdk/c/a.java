...
public final class a extends b {
    private HttpURLConnection jbL = null;

    public a(HttpURLConnection httpURLConnection) {
        this.jbL = httpURLConnection;
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void a(com.tencent.mm.sdk.c.b.b r15, com.tencent.mm.sdk.c.b.c r16) {
        /*
        r14 = this;
        r2 = 0;
        r12 = 1;
        ...
        r1 = r14.jbL;	 Catch:{ Exception -> 0x0261, all -> 0x0251 }
        r4 = r15.jbJ;	 Catch:{ Exception -> 0x0261, all -> 0x0251 }
        r1.setConnectTimeout(r4);	 Catch:{ Exception -> 0x0261, all -> 0x0251 }
        r4 = r14.jbL;	 Catch:{ Exception -> 0x0261, all -> 0x0251 }
        r1 = r15.ozD;	 Catch:{ Exception -> 0x0261, all -> 0x0251 }
    ...
    L_0x0033:
        ...
        r1.setRequestProperty(r4, r5);	 Catch:{ Exception -> 0x0261, all -> 0x0251 }
        r5 = r14.jbL;	 Catch:{ Exception -> 0x0261, all -> 0x0251 }
        r6 = "Cookie";
        r7 = r15.ozF;	 Catch:{ Exception -> 0x0261, all -> 0x0251 }
    ...
    L_0x008b:
        ...
        r6 = r4;
    L_0x0098:
        r1 = r14.jbL;	 Catch:{ Exception -> 0x026d, all -> 0x0259 }
        r4 = r1.getResponseCode();	 Catch:{ Exception -> 0x026d, all -> 0x0259 }
        r1 = r14.jbL;	 Catch:{ Exception -> 0x0273, all -> 0x0259 }
        r5 = "set-cookie";
        r1 = r1.getHeaderField(r5);	 Catch:{ Exception -> 0x0273, all -> 0x0259 }
        r5 = r14.jbL;	 Catch:{ Exception -> 0x0273, all -> 0x0259 }
        r7 = "Content-Encoding";
        r5 = r5.getHeaderField(r7);	 Catch:{ Exception -> 0x0273, all -> 0x0259 }
        r7 = r14.jbL;	 Catch:{ Exception -> 0x0273, all -> 0x0259 }
    ...
    L_0x00ce:
        r0 = r16;
        r2 = r0.usn;	 Catch:{ Exception -> 0x0103, all -> 0x018c }
        if (r2 == 0) goto L_0x0185;
    L_0x00d4:
        r0 = r16;
        r2 = r0.usn;	 Catch:{ Exception -> 0x0103, all -> 0x018c }
        r2 = r2.filePath;	 Catch:{ Exception -> 0x0103, all -> 0x018c }
        r2 = com.tencent.mm.sdk.platformtools.bg.mA(r2);	 Catch:{ Exception -> 0x0103, all -> 0x018c }
        if (r2 == 0) goto L_0x0185;
    L_0x00e0:
    ...
    L_0x0107:
        ...
        com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r6, r1, r7, r8);	 Catch:{ all -> 0x025c }
    ...
    L_0x01a2:
        ...
        r1 = com.tencent.mm.sdk.c.b.CO(r1);	 Catch:{ Exception -> 0x0103, all -> 0x018c }
        r0 = r16;
        r0.ozF = r1;	 Catch:{ Exception -> 0x0103, all -> 0x018c }
    ...
    L_0x01c0:
        ...
        com.tencent.mm.sdk.platformtools.w.d(r1, r2);	 Catch:{ Exception -> 0x0103, all -> 0x018c }
    ...
    L_0x01fb:
        ...
        com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r2, r1, r4, r6);
        goto L_0x01e7;
    L_0x0208:
        r1 = move-exception;
        r2 = "MicroMsg.HttpURLConnectionWrapper";
    ...
    L_0x0219:
        ...
        r5 = "";
        r6 = new java.lang.Object[r3];
        com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r2, r1, r5, r6);
        goto L_0x0120;
    L_0x0227:
        r1 = move-exception;
        r2 = "MicroMsg.HttpURLConnectionWrapper";
    ...
    L_0x0243:
        ...
        r5 = "";
        r3 = new java.lang.Object[r3];
        com.tencent.mm.sdk.platformtools.w.printErrStackTrace(r4, r2, r5, r3);
        goto L_0x0198;
    L_0x0251:
        r1 = move-exception;
        r6 = r2;
