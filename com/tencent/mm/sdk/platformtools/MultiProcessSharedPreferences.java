...
public class MultiProcessSharedPreferences extends ContentProvider implements SharedPreferences {
    ...
    private List<SoftReference<OnSharedPreferenceChangeListener>> eE;
    private BroadcastReceiver iRM;
    private Context mContext;
    private int mMode;
    private String mName;
    private boolean uum;
    private UriMatcher uun;
    ...
    public final class b implements Editor {
        ...
        final /* synthetic */ MultiProcessSharedPreferences uup;

        public b(MultiProcessSharedPreferences multiProcessSharedPreferences) {
            this.uup = multiProcessSharedPreferences;
        }
        ...
        public final Editor putStringSet(String str, Set<String> set) {
            synchronized (this) {
                this.uub.put(str, set == null ? null : new HashSet(set));
            }
            return this;
        }
        ...
        private boolean setValue(String str) {
            ...
            boolean z;
            synchronized (this.uup) {
                this.uup.eb(this.uup.mContext);
                String[] strArr = new String[]{String.valueOf(this.uup.mMode), String.valueOf(this.uuc)};
                synchronized (this) {
                    if (this.uup.mContext.getContentResolver().update(Uri.withAppendedPath(Uri.withAppendedPath(MultiProcessSharedPreferences.AUTHORITY_URI, this.uup.mName), str), c.h((HashMap) this.uub), null, strArr) > 0) {
                        z = true;
                    } else {
                        z = false;
                    }
    ...
    private MultiProcessSharedPreferences(Context context, String str, int i) {
        ...
        this.mName = str;
        this.mMode = i;
        this.uum = context.getPackageManager().isSafeMode();
    }
    ...
    public void registerOnSharedPreferenceChangeListener(OnSharedPreferenceChangeListener onSharedPreferenceChangeListener) {
        synchronized (this) {
            ...
            if (bool != null && bool.booleanValue()) {
                ...
                if (this.iRM == null) {
                    this.iRM = new BroadcastReceiver(this) {
                        final /* synthetic */ MultiProcessSharedPreferences uup;
                        ...
                        public final void onReceive(Context context, Intent intent) {
                            ...
                            if (this.uup.mName.equals(intent.getStringExtra("name")) && list != null) {
                                List<SoftReference> arrayList = new ArrayList(this.uup.eE);
                                for (int size = list.size() - 1; size >= 0; size--) {
                                    ...
                                    for (SoftReference softReference : arrayList) {
                                        ...
                                        if (onSharedPreferenceChangeListener != null) {
                                            onSharedPreferenceChangeListener.onSharedPreferenceChanged(this.uup, str);
                                        }
                                    }
                                }
                            }
                    ...
                    this.mContext.registerReceiver(this.iRM, new IntentFilter(Pz(this.mName)));
                }
            }
        }
    }
    ...
    public void unregisterOnSharedPreferenceChangeListener(OnSharedPreferenceChangeListener onSharedPreferenceChangeListener) {
        synchronized (this) {
            ...
            if (this.eE != null) {
                for (SoftReference softReference : this.eE) {
                ...
                if (this.eE.isEmpty() && this.iRM != null) {
    ...
    public boolean onCreate() {
        eb(getContext());
        this.uun = new UriMatcher(-1);
        this.uun.addURI(AUTHORITY, "*/getAll", 1);
        this.uun.addURI(AUTHORITY, "*/getString", 2);
        this.uun.addURI(AUTHORITY, "*/getInt", 3);
        this.uun.addURI(AUTHORITY, "*/getLong", 4);
        this.uun.addURI(AUTHORITY, "*/getFloat", 5);
        this.uun.addURI(AUTHORITY, "*/getBoolean", 6);
        this.uun.addURI(AUTHORITY, "*/contains", 7);
        this.uun.addURI(AUTHORITY, "*/apply", 8);
        this.uun.addURI(AUTHORITY, "*/commit", 9);
        this.uun.addURI(AUTHORITY, "*/registerOnSharedPreferenceChangeListener", 10);
        this.uun.addURI(AUTHORITY, "*/unregisterOnSharedPreferenceChangeListener", 11);
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        switch (this.uun.match(uri)) {
            ...
            case 10:
                bJv();
                num = (Integer) this.uuo.get(str3);
                parseInt = (num == null ? 0 : num.intValue()) + 1;
                this.uuo.put(str3, Integer.valueOf(parseInt));
                num2 = (Integer) this.uuo.get(str3);
                str4 = Columns.VALUE;
            ...
            case 11:
                ...
                this.uuo.remove(str3);
                String str6 = Columns.VALUE;
                if (this.uuo.containsKey(str3)) {
                    z = false;
                }
