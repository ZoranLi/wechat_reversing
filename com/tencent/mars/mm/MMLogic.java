...
public class MMLogic {
    ...
    private static void reportFlow(int i, int i2, int i3, int i4) {
        ...
        final b bVar = z.MK().ifC;
        w.i("C2Java", "reportNetFlow time[%d,%d] sum:%d wr[%d,%d] ws[%d,%d] mr[%d,%d] ms[%d,%d] fgbg:%b Moniter:%s", Long.valueOf(lastReportTime), Long.valueOf(bg.az(lastReportTime)), Integer.valueOf(i5), Integer.valueOf(i), Integer.valueOf(totalWifiRecv), Integer.valueOf(i2), Integer.valueOf(totalWifiSend), Integer.valueOf(i3), Integer.valueOf(totalMobileRecv), Integer.valueOf(i4), Integer.valueOf(totalMobileSend), Boolean.valueOf(com.tencent.mm.sdk.a.b.foreground), bVar);
        if (bVar != null) {
            if (i5 >= 102400 || bg.az(lastReportTime) >= 30) {
                lastReportTime = bg.Ny();
                    ...
                    z.MM().post(new Runnable() {
                        public final void run() {
                            try {
                                ...
                                w.e("C2Java", "reportFlowData :%s", bg.g(th));
                            }
                        }
                    });
                } catch (Throwable th) {
