...
public class PlatformComm {
    ...
    public static class C2Java {
        ...
        public static int getNetInfo() {
            ...
            try {
                ...
                try {
                    ...
                    w.printErrStackTrace(PlatformComm.TAG, e, "", new Object[0]);
                    return 3;
                }
            } catch (Exception e2) {
        ...
        public static int getStatisticsNetType() {
            ...
            try {
                int netType = am.getNetType(PlatformComm.context);
                if (netType == -1) {
                    return -1;
                }
                ...
                w.e(PlatformComm.TAG, exception2String(e));
                w.printErrStackTrace(PlatformComm.TAG, e, "", new Object[0]);
        ...
        public static boolean startAlarm(int i, int i2) {
            ...
            if (PlatformComm.context == null) {
                ...
                try {
                    ...
                    w.e(PlatformComm.TAG, exception2String(e));
                    w.printErrStackTrace(PlatformComm.TAG, e, "", new Object[z]);
        ...
        public static WifiInfo getCurWifiInfo() {
            try {
                ...
                try {
                    ...
                    w.e(PlatformComm.TAG, "getActiveNetworkInfo failed.");
                    activeNetworkInfo = null;
                }
                if (activeNetworkInfo != null) {
                ...
                w.printErrStackTrace(PlatformComm.TAG, e2, "", new Object[0]);
                return null;
            }
        }
        ...
        public static SIMInfo getCurSIMInfo() {
            try {
                ...
                int iSPCode = am.getISPCode(PlatformComm.context);
                if (iSPCode == 0) {
                    return null;
                }
                SIMInfo sIMInfo = new SIMInfo();
                sIMInfo.ispCode = String.valueOf(iSPCode);
                w.d(PlatformComm.TAG, "getISPCode MCC_MNC=%s", sIMInfo.ispCode);
                sIMInfo.ispName = am.getISPName(PlatformComm.context);
                return sIMInfo;
            } catch (Throwable e) {
                w.printErrStackTrace(PlatformComm.TAG, e, "", new Object[0]);
                return null;
        ...
        public static boolean isNetworkConnected() {
            ...
            if (PlatformComm.context == null) {
                ...
                try {
                    z = am.isNetworkConnected(PlatformComm.context);
                } catch (Throwable e) {
                    w.e(PlatformComm.TAG, exception2String(e));
                    w.printErrStackTrace(PlatformComm.TAG, e, "", new Object[z]);
                    Assert.assertTrue(e.getClass().getSimpleName() + ":" + e.getStackTrace()[z] + ", " + e.getStackTrace()[1], z);
