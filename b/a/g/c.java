...
public final class c {
    ...
    private static final Map<String, String> xpX;
    ...
    static {
        ...
        hashMap.put("+", "%20");
        hashMap.put("%7E", "~");
        xpX = Collections.unmodifiableMap(hashMap);
    }

    public static String encode(String str) {
        d.d(str, "Cannot encode null object");
        try {
            String encode = URLEncoder.encode(str, CHARSET);
            String str2 = encode;
            for (Entry entry : xpX.entrySet()) {
    ...
    public static String decode(String str) {
        d.d(str, "Cannot decode null object");
        try {
