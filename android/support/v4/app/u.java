...
public final class u {
    ...
    static class b implements a {
        ...
        public Intent a(Activity activity) {
            ...
            try {
                return u.b((Context) activity, componentName) == null ? android.support.v4.content.b.makeMainActivity(componentName) : new Intent().setComponent(componentName);
    ...
    public static boolean a(Activity activity, Intent intent) {
        return rH.a(activity, intent);
    }

    public static void b(Activity activity, Intent intent) {
        rH.b(activity, intent);
    }

    public static Intent a(Activity activity) {
        return rH.a(activity);
    }
    ...
    public static String b(Context context, ComponentName componentName) {
        return rH.a(context, context.getPackageManager().getActivityInfo(componentName, FileUtils.S_IWUSR));
    }
}
