...
final class z {
    ...
    public static class a implements w, x {
        ...
        public a(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z, boolean z2, boolean z3, int i4, CharSequence charSequence4, boolean z4, ArrayList<String> arrayList, Bundle bundle, String str, boolean z5, String str2) {
            ...
            this.sE = lights.setFullScreenIntent(pendingIntent2, z6).setLargeIcon(bitmap).setNumber(i).setUsesChronometer(z3).setPriority(i4).setProgress(i2, i3, z).setLocalOnly(z4).setGroup(str).setGroupSummary(z5).setSortKey(str2);
    ...
    public static void a(Builder builder, android.support.v4.app.ab.a aVar) {
        Action.Builder builder2 = new Action.Builder(aVar.getIcon(), aVar.getTitle(), aVar.bk());
        if (aVar.bl() != null) {
            for (RemoteInput addRemoteInput : ah.a(aVar.bl())) {
