...
public class FileProvider extends ContentProvider {
    private static final String[] tl = new String[]{"_display_name", "_size"};
    private static final File tm = new File("/");
    private static HashMap<String, a> tn = new HashMap();
    private a to;
    ...
    static class b implements a {
        ...
        final HashMap<String, File> tq = new HashMap();
        ...
        public final File a(Uri uri) {
            ...
            File file = (File) this.tq.get(decode);
            if (file == null) {
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        if (providerInfo.exported) {
            ...
            this.to = e(context, providerInfo.authority);
        } else {
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        return this.to.a(uri).delete() ? 1 : 0;
    }
    ...
    private static a e(Context context, String str) {
        ...
        synchronized (tn) {
            ...
            if (aVar == null) {
                ...
                try {
                    aVar = new b(str);
                    XmlResourceParser loadXmlMetaData = context.getPackageManager().resolveContentProvider(str, FileUtils.S_IWUSR).loadXmlMetaData(context.getPackageManager(), "android.support.FILE_PROVIDER_PATHS");
                    ...
                    while (true) {
                        ...
                        if (next == 1) {
                            ...
                            if (a == null) {
                                ...
                                aVar.tq.put(attributeValue, a.getCanonicalFile());
                            }
                        }
                    }
                    tn.put(str, aVar);
