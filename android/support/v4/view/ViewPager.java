...
public class ViewPager extends ViewGroup {
    ...
    private int yS;
    private boolean yT;
    private android.support.v4.widget.i yU;
    private android.support.v4.widget.i yV;
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ViewPager.ym);
    ...
    class c extends a {
        ...
        public final void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            a.setScrollable(bY());
            if (accessibilityEvent.getEventType() == Downloads.RECV_BUFFER_SIZE && this.zj.yr != null) {
                a.setItemCount(this.zj.yr.getCount());
                a.setFromIndex(this.zj.ys);
                a.setToIndex(this.zj.ys);
            }
        }
        ...
        public final void a(View view, android.support.v4.view.a.b bVar) {
            ...
            if (this.zj.canScrollHorizontally(1)) {
        ...
        private boolean bY() {
            return this.zj.yr != null && this.zj.yr.getCount() > 1;
        }
    }
    ...
    public ViewPager(Context context, AttributeSet attributeSet) {
        ...
        this.yU = new android.support.v4.widget.i(context2);
        this.yV = new android.support.v4.widget.i(context2);
        this.yR = (int) (25.0f * f);
        this.yS = (int) (2.0f * f);
        this.yL = (int) (16.0f * f);
        ...
        z.b((View) this, new t(this) {
            ...
            public final ap a(View view, ap apVar) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ap b = z.b(this.zj.getChildAt(i), a);
    ...
    public final void a(u uVar) {
        ...
        if (this.zd != null && uVar2 != uVar) {
            this.zd.b(uVar2, uVar);
        }
    }
    ...
    private void a(int i, boolean z, int i2, boolean z2) {
        ...
        b aa = aa(i);
        if (aa != null) {
            bP = (int) (((float) bP()) * Math.max(this.yD, Math.min(aa.zn, this.yE)));
        } else {
            bP = 0;
        }
        if (z) {
            if (getChildCount() == 0) {
                ...
                int currX;
                int i3;
                Object obj = (this.yw == null || this.yw.isFinished()) ? null : 1;
                if (obj != null) {
                    currX = this.yx ? this.yw.getCurrX() : this.yw.getStartX();
                    this.yw.abortAnimation();
                    setScrollingCacheEnabled(false);
                    i3 = currX;
                } else {
                ...
                if (bP == 0 && i4 == 0) {
                    ...
                    currX = bP();
                    int i5 = currX / 2;
                    float sin = (((float) i5) * ((float) Math.sin((double) ((float) (((double) (Math.min(1.0f, (1.0f * ((float) Math.abs(bP))) / ((float) currX)) - 0.5f)) * 0.4712389167638204d))))) + ((float) i5);
                    int abs = Math.abs(i2);
                    i5 = Math.min(abs > 0 ? Math.round(1000.0f * Math.abs(sin / ((float) abs))) * 4 : (int) (((((float) Math.abs(bP)) / ((((float) currX) * 1.0f) + ((float) this.yz))) + 1.0f) * 100.0f), 600);
                    this.yx = false;
                    this.yw.startScroll(i3, scrollY, bP, i4, i5);
                    z.F(this);
                }
            }
            if (z2) {
    ...
    final void bQ() {
        ...
        this.yn = count;
        boolean z = this.eh.size() < (this.yJ * 2) + 1 && this.eh.size() < count;
        boolean z2 = false;
        int i = this.ys;
        boolean z3 = z;
        int i2 = 0;
    ...
    L_0x030c:
        ...
        goto L_0x001a;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.ViewPager.Z(int):void");
    }
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (i != i3) {
            ...
            if (i3 <= 0 || this.eh.isEmpty()) {
                b aa = aa(this.ys);
                i5 = (int) ((aa != null ? Math.min(aa.zn, this.yE) : 0.0f) * ((float) ((i - getPaddingLeft()) - getPaddingRight())));
                if (i5 != getScrollX()) {
                    r(false);
                    scrollTo(i5, getScrollY());
                }
            } else if (this.yw.isFinished()) {
        ...
        for (paddingRight = 0; paddingRight < childCount; paddingRight++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams.zo) {
                    b ap = ap(childAt2);
                    if (ap != null) {
                        i5 = ((int) (ap.zn * ((float) max))) + paddingLeft;
                        if (layoutParams.zp) {
    ...
    private boolean ab(int i) {
        if (this.eh.size() != 0) {
            ...
            int i3 = bU.position;
            float f2 = ((((float) i) / ((float) bP)) - bU.zn) / (bU.zm + f);
            bP = (int) (((float) i2) * f2);
            this.yY = false;
            a(i3, f2, bP);
            if (this.yY) {
    ...
    private void a(int i, float f, int i2) {
        ...
        if (this.za != null) {
            paddingRight = this.za.size();
            for (paddingLeft = 0; paddingLeft < paddingRight; paddingLeft++) {
                e eVar = (e) this.za.get(paddingLeft);
                if (eVar != null) {
                    eVar.a(i, f, i2);
                }
            }
        ...
        switch (motionEvent.getAction() & 255) {
            ...
            case 1:
                if (this.iC) {
                    ...
                    int scrollX = getScrollX();
                    b bU = bU();
                    float f2 = ((float) this.yz) / ((float) bP);
                    i = bU.position;
                    f = ((((float) scrollX) / ((float) bP)) - bU.zn) / (bU.zm + f2);
                    if (Math.abs((int) (o.d(motionEvent, o.b(motionEvent, this.fl)) - this.xC)) <= this.yR || Math.abs(a) <= this.yP) {
                        scrollX = (int) ((((float) i) + f) + (i >= this.ys ? 0.4f : 0.6f));
                    } else {
                        if (a <= 0) {
                            i++;
                        }
                    ...
                    if (this.eh.size() > 0) {
                        scrollX = Math.max(((b) this.eh.get(0)).position, Math.min(scrollX, ((b) this.eh.get(this.eh.size() - 1)).position));
                    }
        ...
        if (this.yz > 0 && this.yA != null && this.eh.size() > 0 && this.yr != null) {
            ...
            while (i4 < i2) {
                ...
                if (((float) this.yz) + f3 > ((float) scrollX)) {
                    this.yA.setBounds(Math.round(f3), this.yB, Math.round(((float) this.yz) + f3), this.yC);
                    this.yA.draw(canvas);
                }
        ...
        if (descendantFocusability != 393216) {
            for (int i3 = 0; i3 < getChildCount(); i3++) {
                ...
                if (childAt.getVisibility() == 0) {
                    b ap = ap(childAt);
                    if (ap != null && ap.position == this.ys) {
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        while (childCount != i2) {
            ...
            if (childAt.getVisibility() == 0) {
                b ap = ap(childAt);
                if (ap != null && ap.position == this.ys && childAt.requestFocus(i, rect)) {
                    return true;
                }
            }
            childCount += i3;
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt.getVisibility() == 0) {
                b ap = ap(childAt);
                if (ap != null && ap.position == this.ys && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                    return true;
                }
            }
        }
